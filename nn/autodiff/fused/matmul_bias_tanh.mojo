"""FusedMatMulBiasTanh — thin wrapper delegating to FusedMatMulBiasActivation."""
...
struct FusedMatMulBiasTanh[in_dim: Int, out_dim: Int](FusedOp):
    """Fused y = tanh(x @ W + b). Delegates to FusedMatMulBiasActivation."""

    comptime OP_ID: Int = OpID.FUSED_MATMUL_BIAS_TANH._value
    ...
    fn eval[
        ...
        _Impl[Self.in_dim, Self.out_dim, TanhActivation].eval[BATCH](
    ...
    fn vjp[
        ...
        _Impl[Self.in_dim, Self.out_dim, TanhActivation].vjp[BATCH](
    ...
    fn eval_gpu[
        ...
        _Impl[Self.in_dim, Self.out_dim, TanhActivation].eval_gpu[BATCH](
    ...
    fn vjp_gpu[
        ...
        _Impl[Self.in_dim, Self.out_dim, TanhActivation].vjp_gpu[BATCH](
