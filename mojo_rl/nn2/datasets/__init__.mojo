...
# CIFAR10CropFlipAugmenter lives in nn2.training.augmenter (consolidated there
# during the nn2 port — not duplicated under datasets/). Re-exported here so the
# legacy `from mojo_rl.nn.datasets import CIFAR10CropFlipAugmenter` surface keeps
# working after the swap to nn2.datasets.
