"""Conv → (BN) → ReLU block aliases for nn2.

Compositional aliases — each expands to a `Sequential` of existing
primitives, so they get correct forward / vjp / walkers / `set_attr`
propagation for free and need no bespoke kernels.
