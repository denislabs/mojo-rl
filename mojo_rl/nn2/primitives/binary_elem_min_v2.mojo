...
struct BinaryElemMinV2[DIM: Int](BinaryModuleV2):
    ...
    def make[target: StaticString, INIT: Initializer]() raises -> Self:
        comptime assert target == "cpu", (
            "BinaryElemMinV2.make[target='gpu', INIT] requires a DeviceContext"
        )
        var m = Self()
    ...
    def make[
        ...
        comptime assert target == "gpu", (
            "BinaryElemMinV2.make[target='cpu', INIT](ctx) — drop ctx for CPU"
        )
        var m = Self()
    ...
    def forward[
        ...
        assert_tag_for["BinaryElemMinV2", target](self.ts.target_tag)
        ...
        comptime if target == "cpu":
            ...
            raise Error("BinaryElemMinV2: GPU path not yet implemented")
    ...
    def backward[
        ...
        comptime if target == "cpu":
            ...
            raise Error("BinaryElemMinV2: GPU backward not yet implemented")
