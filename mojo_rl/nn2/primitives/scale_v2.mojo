...
from forward. Conforms to `ModuleV2`.
"""
...
struct ScaleV2[DIM: Int](ModuleV2):
    ...
    def make[target: StaticString, INIT: Initializer]() raises -> Self:
        comptime assert target == "cpu", (
            "ScaleV2.make[target='gpu', INIT] requires a DeviceContext"
        )
        var s = Self()
    ...
    def make[
        ...
        comptime assert target == "gpu", (
            "ScaleV2.make[target='cpu', INIT](ctx) — drop ctx for CPU"
        )
        var s = Self()
    ...
    def forward[
        ...
        assert_tag_for["ScaleV2", target](self.ts.target_tag)
        ...
        comptime if target == "cpu":
            ...
            raise Error("ScaleV2: GPU path not yet implemented")
    ...
    def backward[
        ...
        comptime if target == "cpu":
            ...
            raise Error("ScaleV2: GPU backward not yet implemented")
