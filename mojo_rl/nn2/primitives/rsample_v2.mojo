"""RSampleV2 — retrofit (Phase E). Thin Module wrapper around the
...
struct RSampleV2[ACT: Int](ModuleV2):
    ...
    def make[target: StaticString, INIT: Initializer]() raises -> Self:
        comptime assert target == "cpu", (
            "RSampleV2.make[target='gpu', INIT] requires a DeviceContext"
        )
        var r = Self()
    ...
    def make[
        ...
        comptime assert target == "gpu", (
            "RSampleV2.make[target='cpu', INIT](ctx) — drop ctx for CPU"
        )
        var r = Self()
    ...
    def forward[
        ...
        comptime assert Self.ACT >= 1, "RSampleV2[ACT]: ACT >= 1"
        assert_tag_for["RSampleV2", target](self.ts.target_tag)
        ...
        comptime if target == "cpu":
            ...
            raise Error("RSampleV2[ACT]: GPU path not yet implemented")
    ...
    def backward[
        ...
        comptime if target == "cpu":
            ...
            raise Error("RSampleV2[ACT]: GPU backward not yet implemented")
