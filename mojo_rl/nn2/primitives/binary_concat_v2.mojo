...
No params. Conforms to `BinaryModuleV2`.
"""
...
struct BinaryConcatV2[IN0_DIM_: Int, IN1_DIM_: Int](BinaryModuleV2):
    ...
    def make[target: StaticString, INIT: Initializer]() raises -> Self:
        comptime assert target == "cpu", (
            "BinaryConcatV2.make[target='gpu', INIT] requires a DeviceContext"
        )
        var c = Self()
    ...
    def make[
        ...
        comptime assert target == "gpu", (
            "BinaryConcatV2.make[target='cpu', INIT](ctx) — drop ctx for CPU"
        )
        var c = Self()
    ...
    def forward[
        ...
        assert_tag_for["BinaryConcatV2", target](self.ts.target_tag)
        ...
        comptime if target == "cpu":
            ...
            raise Error("BinaryConcatV2: GPU path not yet implemented")
    ...
    def backward[
        ...
        comptime if target == "cpu":
            ...
            raise Error("BinaryConcatV2: GPU backward not yet implemented")
