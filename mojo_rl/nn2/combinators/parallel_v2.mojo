...
from .residual_v2 import _elementwise_add_kernel
...
struct ParallelV2[A: ModuleV2, B: ModuleV2](ModuleV2):
    ...
    def __init__(out self):
        ...
        ), "ParallelV2 requires A.IN_DIM == B.IN_DIM"
    ...
    def make[target: StaticString, INIT: Initializer]() raises -> Self:
        comptime assert target == "cpu", (
            "ParallelV2.make[target='gpu', INIT] requires a DeviceContext"
        )
        var p = Self()
    ...
    def make[
        ...
        comptime assert target == "gpu", (
            "ParallelV2.make[target='cpu', INIT](ctx) — drop ctx for CPU"
        )
        var p = Self()
    ...
    def forward[
        ...
        assert_tag_for["ParallelV2", target](self.ts.target_tag)
