...
struct ResidualV2[Inner: ModuleV2](ModuleV2):
    ...
    def __init__(out self):
        ...
        ), "ResidualV2 requires Inner.IN_DIM == Inner.OUT_DIM"
    ...
    def make[target: StaticString, INIT: Initializer]() raises -> Self:
        comptime assert target == "cpu", (
            "ResidualV2.make[target='gpu', INIT] requires a DeviceContext"
        )
        var r = Self()
    ...
    def make[
        ...
        comptime assert target == "gpu", (
            "ResidualV2.make[target='cpu', INIT](ctx) — drop ctx for CPU"
        )
        var r = Self()
    ...
    def forward[
        ...
        assert_tag_for["ResidualV2", target](self.ts.target_tag)
