"""LeWM (LeWorldModel JEPA) — nn2 port (experimental).

Agent assembly for the LeWM world model on the nn2 framework. The
...
`mojo_rl/nn2/` proper; this package wires them into the JEPA encoder,
