...
def generate_world_cpu(
    ...
    return generate_world_inline(
        ...
        mountain.unsafe_ptr().unsafe_bitcast[Float32]().as_unsafe_any_origin(),
        path.unsafe_ptr().unsafe_bitcast[Float32]().as_unsafe_any_origin(),
        tree.unsafe_ptr().unsafe_bitcast[Float32]().as_unsafe_any_origin(),
        map_out,
        always_diamond,
    )
