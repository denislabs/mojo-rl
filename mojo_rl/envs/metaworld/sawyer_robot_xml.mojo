"""Sawyer 7-DOF arm + gripper + mocap body.

From: references/Metaworld-master/metaworld/assets/objects/assets/xyz_base.xml
"""

comptime sawyer_robot_xml = """
<mujocoinclude>
    <worldbody>
        <!-- Cameras -->
        ...
        <body name="base" childclass="xyz_base" pos="0 0 0">
            ...
            <body name="pedestal" pos="0 0 0">
                ...
                <geom pos="0.26 0.345 -0.91488" quat="0.5 0.5 -0.5 -0.5" type="mesh"
                      contype="0" conaffinity="0" group="1" rgba="0.2 0.2 0.2 1" mesh="pedestal"/>
            ...
            <body name="right_arm_base_link" pos="0 0 0">
                ...
                <body name="right_l0" pos="0 0 0.08">
                    ...
                    <body name="head" pos="0 0 0.2965">
                        ...
                        <geom type="mesh" contype="0" conaffinity="0" group="1"
                              rgba="0.5 0.1 0.1 1" mesh="head"/>
                        <body name="screen" pos="0.03 0 0.105" quat="0.5 0.5 0.5 0.5">
                            <inertial pos="0 0 0" mass="0.0001" diaginertia="1e-08 1e-08 1e-08"/>
                            <geom size="0.12 0.07 0.001" type="box" contype="0" conaffinity="0"
                                  group="1" rgba="0.2 0.2 0.2 0"/>
                        </body>
                        <body name="head_camera" pos="0.0228027 0 0.216572"
                              quat="0.342813 -0.618449 0.618449 -0.342813">
                            <inertial pos="0.0228027 0 0.216572"
                                      quat="0.342813 -0.618449 0.618449 -0.342813"
                                      mass="0" diaginertia="0 0 0"/>
                            <site name="headsite" pos="0 0 0" size="0.01"/>
                        </body>
                    </body>

                    <body name="right_torso_itb" pos="-0.055 0 0.22"
                    ...
                    <body name="right_l1" pos="0.081 0.05 0.237" quat="0.5 -0.5 0.5 0.5">
                        ...
                        <body name="right_l2" pos="0 -0.14 0.1425" quat="0.707107 0.707107 0 0">
                            ...
                            <geom type="mesh" contype="0" conaffinity="0" group="1"
                                  rgba="0.5 0.1 0.1 1" mesh="l2"/>
                            <geom size="0.06 0.17" pos="0 0 0.08" type="cylinder"
                                  rgba="0.5 0.1 0.1 0"/>

                            <body name="right_l3" pos="0 -0.042 0.26"
                                ...
                                <body name="right_l4" pos="0 -0.125 -0.1265"
                                    ...
                                    <body name="right_l5" pos="0 0.031 0.275"
                                        ...
                                        <joint name="right_j5" pos="0 0 0" axis="0 0 1"
                                               limited="true" range="-2.9761 2.9761" damping="10"/>
                                        <geom type="mesh" contype="0" conaffinity="0" group="1"
                                              rgba="0.5 0.1 0.1 1" mesh="l5"/>

                                        <body name="right_hand_camera" pos="0.039552 -0.033 0.0695"
                                              quat="0.707107 0 0.707107 0">
                                            <inertial pos="0.039552 -0.033 0.0695"
                                                      quat="0.707107 0 0.707107 0"
                                                      mass="0" diaginertia="0 0 0"/>
                                        </body>
                                        ...
                                        <body name="right_l6" pos="0 -0.11 0.1053"
                                            ...
                                            <geom type="mesh" contype="4" conaffinity="2" group="1"
                                                  rgba="0.5 0.1 0.1 1" mesh="l6"/>
                                            <geom size="0.055 0.025" pos="0 0.015 -0.01"
                                                  type="cylinder" rgba="0.5 0.1 0.1 0"/>

                                            <body name="right_hand" pos="0 0 0.0245"
                                                  quat="0.707107 0 0 0.707107">
                                                <inertial pos="1e-08 1e-08 1e-08"
                                                ...
                                                <geom size="0.035 0.014" pos="0 0 0.015"
                                                      type="cylinder" rgba="0 0 0 1"/>

                                                <body name="hand" pos="0 0 0.12" quat="-1 0 1 0">
                                                    <camera name="behindGripper" mode="track"
                                                            pos="0 0 -0.5" quat="0 1 0 0" fovy="60"/>
                                                    <camera name="gripperPOV" mode="track"
                                                            pos="0.04 -0.06 0" quat="-1 -1.3 0 0"
                                                            fovy="90"/>

                                                    <site name="endEffector" pos="0.04 0 0"
                                                          size="0.01" rgba="1 1 1 0"/>
                                                    <geom name="rail" type="box" pos="-0.05 0 0"
                                                          density="7850" size="0.005 0.055 0.005"
                                                          rgba="0.5 0.5 0.5 1" condim="3"
                                                          friction="2 0.1 0.002"/>

                                                    <body name="rightclaw" pos="0 -0.05 0">
                                                        <geom class="base_col" name="rightclaw_it"
                                                              condim="4" margin="0.001" type="box"
                                                              user="0" pos="0 0 0"
                                                              size="0.045 0.003 0.015"
                                                              rgba="1 1 1 1"/>
                                                        <joint name="r_close" pos="0 0 0" axis="0 1 0"
                                                               range="0 0.04" armature="100"
                                                               damping="1000" limited="true"
                                                               type="slide"/>
                                                        <site name="rightEndEffector" pos="0.045 0 0"
                                                              size="0.01" rgba="1.0 0.0 0.0 1.0"/>
                                                        <body name="rightpad" pos="0 0.003 0">
                                                            <geom name="rightpad_geom" condim="4"
                                                                  margin="0.001" type="box" user="0"
                                                                  pos="0 0 0"
                                                                  size="0.045 0.003 0.015"
                                                                  rgba="1 1 1 1"
                                                    ...
                                                    <body name="leftclaw" pos="0 0.05 0">
                                                        <geom class="base_col" name="leftclaw_it"
                                                              condim="4" margin="0.001" type="box"
                                                              user="0" pos="0 0 0"
                                                              size="0.045 0.003 0.015"
                                                              rgba="0 1 1 1"/>
                                                        <joint name="l_close" pos="0 0 0" axis="0 1 0"
                                                               range="-0.03 0" armature="100"
                                                               damping="1000" limited="true"
                                                               type="slide"/>
                                                        <site name="leftEndEffector" pos="0.045 0 0"
                                                              size="0.01" rgba="1.0 0.0 0.0 1.0"/>
                                                        <body name="leftpad" pos="0 -0.003 0">
                                                            <geom name="leftpad_geom" condim="4"
                                                                  margin="0.001" type="box" user="0"
                                                                  pos="0 0 0"
                                                                  size="0.045 0.003 0.015"
                                                                  rgba="0 1 1 1"
                                    ...
                                    <body name="right_l4_2" pos="0 0 0">
                                        <inertial pos="1e-08 1e-08 1e-08"
                                                  quat="0.820473 0.339851 -0.17592 0.424708"
                                                  mass="1e-08" diaginertia="1e-08 1e-08 1e-08"/>
                                    </body>
                                </body>
                            </body>
        ...
        <body mocap="true" name="mocap" pos="0 0 0">
            <geom conaffinity="0" contype="0" pos="0 0 0" rgba="0.0 0.5 0.5 0"
                  size="0.01" type="sphere"/>
            <site name="mocap" pos="0 0 0" rgba="0.0 0.5 0.5 0" size="0.01"
                  type="sphere"/>
        </body>
    </worldbody>
</mujocoinclude>
