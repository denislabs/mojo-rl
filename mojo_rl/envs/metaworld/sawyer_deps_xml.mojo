"""Sawyer robot dependencies — compiler flags, named default classes, mesh assets.
    ...
    <default>
        <default class="xyz_base">
            ...
            <default class="base_viz">
                <geom conaffinity="0" condim="4" contype="0" group="1" margin="0.001"
                      solimp="0.8 0.9 0.01" solref="0.02 1" type="mesh"/>
            </default>
            <default class="base_col">
                <geom conaffinity="1" condim="4" contype="1" group="4" margin="0.001"
                      material="xyz_col" solimp="0.8 0.9 0.01" solref="0.02 1"/>
            </default>
        </default>
    </default>
</mujocoinclude>
