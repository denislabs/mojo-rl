...
comptime _DOG_HEAD = """<mujoco model="dog">
...
comptime _DOG_FLOOR_STAND_WALK = """    <geom name="floor" type="plane" size="15 15 .1" material="grid" />
"""
comptime _DOG_FLOOR_TROT = """    <geom name="floor" type="plane" size="45 45 .1" material="grid" />
"""
comptime _DOG_FLOOR_RUN = """    <geom name="floor" type="plane" size="135 135 .1" material="grid" />
"""

# --- the dog itself, plus actuators / tendons / sensors ------------------
comptime _DOG_TAIL = """    <body name="torso" pos="0.040403 0 0.41522">
...
comptime _dog_stand_walk_body = _DOG_HEAD + _DOG_FLOOR_STAND_WALK + _DOG_TAIL
