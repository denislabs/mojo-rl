 ...
 */
#define MRL_SERIAL_LAYOUT_N 23

int mrl_serial_layout(long *out, int n) {
    if (out == NULL || n < MRL_SERIAL_LAYOUT_N) return -1;
    int i = 0;
 ...
 * it asked for. */
long mrl_serial_baud_constant(long baud) {
    switch (baud) {
#define MRL_B(n) case n: return (long)B##n;
    MRL_B(0) MRL_B(50) MRL_B(75) MRL_B(110) MRL_B(134) MRL_B(150)
    MRL_B(200) MRL_B(300) MRL_B(600) MRL_B(1200) MRL_B(1800) MRL_B(2400)
    MRL_B(4800) MRL_B(9600) MRL_B(19200) MRL_B(38400)
#ifdef B57600
    MRL_B(57600)
#endif
#ifdef B115200
