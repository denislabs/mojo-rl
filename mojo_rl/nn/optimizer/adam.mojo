...
#
# nn stores each param tensor in its OWN DeviceBuffer (Param.make_gpu), so
...
# — verified by tests/nn/test_grouped_adam_prototype.mojo). The callers gate
...
struct Adam(Optimizer, Saveable):
    ...
    # See `mojo_rl/nn/core/grad_clip.mojo`.
