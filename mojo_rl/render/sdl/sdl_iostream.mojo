...
struct IOStreamInterface(ImplicitlyCopyable, Movable):
    ...
    var size: def(userdata: Ptr[NoneType, MutAnyOrigin]) thin -> Int64
...
def get_io_properties(
    ...
    return _get_dylib_function[
        lib,
        "SDL_GetIOProperties",
        def(context: Ptr[IOStream, MutAnyOrigin]) thin -> PropertiesID,
    ]()(context)
...
def get_io_status(context: Ptr[IOStream, MutAnyOrigin]) raises -> IOStatus:
    ...
    return _get_dylib_function[
        lib,
        "SDL_GetIOStatus",
        def(context: Ptr[IOStream, MutAnyOrigin]) thin -> IOStatus,
    ]()(context)
...
def get_io_size(context: Ptr[IOStream, MutAnyOrigin]) raises -> Int64:
    ...
    return _get_dylib_function[
        lib,
        "SDL_GetIOSize",
        def(context: Ptr[IOStream, MutAnyOrigin]) thin -> Int64,
    ]()(context)
...
def tell_io(context: Ptr[IOStream, MutAnyOrigin]) raises -> Int64:
    ...
    return _get_dylib_function[
        lib, "SDL_TellIO", def(context: Ptr[IOStream, MutAnyOrigin]) thin -> Int64
    ]()(context)
