...
from .sdl_joystick import Joystick, JoystickConnectionState, JoystickID
...
struct GamepadType(Indexer, Intable, TrivialRegisterPassable):
...
struct GamepadButton(Indexer, Intable, TrivialRegisterPassable):
...
struct GamepadButtonLabel(Indexer, Intable, TrivialRegisterPassable):
...
struct GamepadAxis(Indexer, Intable, TrivialRegisterPassable):
...
struct GamepadBindingType(Indexer, Intable, TrivialRegisterPassable):
...
@fieldwise_init
struct GamepadBindingInput(
    ImplicitlyCopyable, Movable, TrivialRegisterPassable
):
    comptime _mlir_type = __mlir_type[
        `!pop.union<`,
        GamepadBindingInputAxis,
        `, `,
        GamepadBindingInputHat,
        `>`,
    ]
...
@fieldwise_init
struct GamepadBindingOutput(
    ImplicitlyCopyable, Movable, TrivialRegisterPassable
):
    comptime _mlir_type = __mlir_type[
        `!pop.union<`, GamepadButton, `, `, GamepadBindingOutputAxis, `>`
    ]
    var _impl: Self._mlir_type
...
@fieldwise_init
struct GamepadBinding(ImplicitlyCopyable, Movable, TrivialRegisterPassable):
...
def add_gamepad_mapping(var mapping: String) raises -> c_int:
...
def add_gamepad_mappings_from_io(
    ...
    return _get_dylib_function[
        ...
        def(src: Ptr[IOStream, MutAnyOrigin], closeio: Bool) thin -> c_int,
    ]()(src, closeio)


def add_gamepad_mappings_from_file(var file: String) raises -> c_int:
...
def get_gamepad_mapping_for_guid(
    guid: GUID, out ret: Ptr[c_char, MutAnyOrigin]
) raises:
...
def get_gamepad_mapping(
    ...
    return _get_dylib_function[
        ...
        def(gamepad: Ptr[Gamepad, MutAnyOrigin]) thin -> Ptr[c_char, MutAnyOrigin],
    ]()(gamepad)


def set_gamepad_mapping(instance_id: JoystickID, var mapping: String) raises:
...
def has_gamepad() raises -> Bool:
    ...
    return _get_dylib_function[lib, "SDL_HasGamepad", def() thin -> Bool]()()
...
def is_gamepad(instance_id: JoystickID) raises -> Bool:
    ...
    return _get_dylib_function[
        lib, "SDL_IsGamepad", def(instance_id: JoystickID) thin -> Bool
    ]()(instance_id)


def get_gamepad_name_for_id(
    ...
    return _get_dylib_function[
        ...
        def(instance_id: JoystickID) thin -> Ptr[c_char, ImmutAnyOrigin],
    ]()(instance_id)


def get_gamepad_path_for_id(
    instance_id: JoystickID,
) raises -> Ptr[c_char, ImmutAnyOrigin]:
...
def get_gamepad_player_index_for_id(instance_id: JoystickID) raises -> c_int:
    ...
    return _get_dylib_function[
        ...
        def(instance_id: JoystickID) thin -> c_int,
    ]()(instance_id)


def get_gamepad_guid_for_id(instance_id: JoystickID) raises -> GUID:
    ...
    return _get_dylib_function[
        lib, "SDL_GetGamepadGUIDForID", def(instance_id: JoystickID) thin -> GUID
    ]()(instance_id)


def get_gamepad_vendor_for_id(instance_id: JoystickID) raises -> UInt16:
    ...
    return _get_dylib_function[
        lib, "SDL_GetGamepadVendorForID", def(instance_id: JoystickID) thin -> UInt16
    ]()(instance_id)


def get_gamepad_product_for_id(instance_id: JoystickID) raises -> UInt16:
    ...
    return _get_dylib_function[
        ...
        def(instance_id: JoystickID) thin -> UInt16,
    ]()(instance_id)
...
def get_gamepad_type_for_id(instance_id: JoystickID) raises -> GamepadType:
    ...
    return _get_dylib_function[
        ...
        def(instance_id: JoystickID) thin -> GamepadType,
    ]()(instance_id)


def get_real_gamepad_type_for_id(instance_id: JoystickID) raises -> GamepadType:
...
def get_gamepad_mapping_for_id(
    instance_id: JoystickID,
) raises -> Ptr[c_char, MutAnyOrigin]:
    ...
    return _get_dylib_function[
        ...
        def(instance_id: JoystickID) thin -> Ptr[c_char, MutAnyOrigin],
    ]()(instance_id)


def open_gamepad(
    instance_id: JoystickID,
) raises -> Ptr[Gamepad, MutAnyOrigin]:
    ...
    return _get_dylib_function[
        lib,
        "SDL_OpenGamepad",
        def(instance_id: JoystickID) thin -> Ptr[Gamepad, MutAnyOrigin],
    ]()(instance_id)


def get_gamepad_from_id(
    instance_id: JoystickID,
) raises -> Ptr[Gamepad, MutAnyOrigin]:
...
def get_gamepad_from_player_index(
    player_index: c_int,
) raises -> Ptr[Gamepad, MutAnyOrigin]:
    ...
    return _get_dylib_function[
        ...
        def(player_index: c_int) thin -> Ptr[Gamepad, MutAnyOrigin],
    ]()(player_index)


def get_gamepad_properties(
    gamepad: Ptr[Gamepad, MutAnyOrigin]
) raises -> PropertiesID:
    ...
    return _get_dylib_function[
        ...
        def(gamepad: Ptr[Gamepad, MutAnyOrigin]) thin -> PropertiesID,
    ]()(gamepad)


def get_gamepad_id(gamepad: Ptr[Gamepad, MutAnyOrigin]) raises -> JoystickID:
    ...
    return _get_dylib_function[
        lib,
        "SDL_GetGamepadID",
        def(gamepad: Ptr[Gamepad, MutAnyOrigin]) thin -> JoystickID,
    ]()(gamepad)


def get_gamepad_name(
    gamepad: Ptr[Gamepad, MutAnyOrigin]
) raises -> Ptr[c_char, ImmutAnyOrigin]:
    ...
    return _get_dylib_function[
        lib,
        "SDL_GetGamepadName",
        def(gamepad: Ptr[Gamepad, MutAnyOrigin]) thin -> Ptr[c_char, ImmutAnyOrigin],
    ]()(gamepad)


def get_gamepad_path(
    gamepad: Ptr[Gamepad, MutAnyOrigin]
) raises -> Ptr[c_char, ImmutAnyOrigin]:
...
def get_gamepad_type(gamepad: Ptr[Gamepad, MutAnyOrigin]) raises -> GamepadType:
    ...
    return _get_dylib_function[
        lib,
        "SDL_GetGamepadType",
        def(gamepad: Ptr[Gamepad, MutAnyOrigin]) thin -> GamepadType,
    ]()(gamepad)


def get_real_gamepad_type(
    gamepad: Ptr[Gamepad, MutAnyOrigin]
) raises -> GamepadType:
...
def get_gamepad_player_index(
    ...
    return _get_dylib_function[
        ...
        def(gamepad: Ptr[Gamepad, MutAnyOrigin]) thin -> c_int,
    ]()(gamepad)


def set_gamepad_player_index(
    gamepad: Ptr[Gamepad, MutAnyOrigin], player_index: c_int
) raises:
...
def get_gamepad_vendor(gamepad: Ptr[Gamepad, MutAnyOrigin]) raises -> UInt16:
    ...
    return _get_dylib_function[
        ...
        def(gamepad: Ptr[Gamepad, MutAnyOrigin]) thin -> UInt16,
    ]()(gamepad)


def get_gamepad_product(gamepad: Ptr[Gamepad, MutAnyOrigin]) raises -> UInt16:
...
def get_gamepad_product_version(
    gamepad: Ptr[Gamepad, MutAnyOrigin]
) raises -> UInt16:
...
def get_gamepad_firmware_version(
    gamepad: Ptr[Gamepad, MutAnyOrigin]
) raises -> UInt16:
...
def get_gamepad_steam_handle(
    ...
    return _get_dylib_function[
        ...
        def(gamepad: Ptr[Gamepad, MutAnyOrigin]) thin -> UInt64,
    ]()(gamepad)


def get_gamepad_connection_state(
    gamepad: Ptr[Gamepad, MutAnyOrigin]
    ...
    return _get_dylib_function[
        ...
        def(gamepad: Ptr[Gamepad, MutAnyOrigin]) thin -> JoystickConnectionState,
    ]()(gamepad)


def get_gamepad_power_info(
    gamepad: Ptr[Gamepad, MutAnyOrigin], percent: Ptr[c_int, MutAnyOrigin]
) raises -> PowerState:
...
def gamepad_connected(gamepad: Ptr[Gamepad, MutAnyOrigin]) raises -> Bool:
    ...
    return _get_dylib_function[
        ...
        def(gamepad: Ptr[Gamepad, MutAnyOrigin]) thin -> Bool,
    ]()(gamepad)


def get_gamepad_joystick(
    gamepad: Ptr[Gamepad, MutAnyOrigin],
    out ret: Ptr[Joystick, MutAnyOrigin],
) raises:
...
def set_gamepad_events_enabled(enabled: Bool) raises -> None:
    ...
    return _get_dylib_function[
        lib, "SDL_SetGamepadEventsEnabled", def(enabled: Bool) thin -> None
    ]()(enabled)


def gamepad_events_enabled() raises -> Bool:
    ...
    return _get_dylib_function[
        lib, "SDL_GamepadEventsEnabled", def() thin -> Bool
    ]()()


def get_gamepad_bindings(
    gamepad: Ptr[Gamepad, MutAnyOrigin], count: Ptr[c_int, MutAnyOrigin]
) raises -> Ptr[Ptr[GamepadBinding, MutAnyOrigin], MutAnyOrigin]:
    ...
    return _get_dylib_function[
        ...
        def(
            gamepad: Ptr[Gamepad, MutAnyOrigin],
            count: Ptr[c_int, MutAnyOrigin],
        ) thin -> Ptr[Ptr[GamepadBinding, MutAnyOrigin], MutAnyOrigin],
    ]()(gamepad, count)


def update_gamepads() raises -> None:
    ...
    return _get_dylib_function[lib, "SDL_UpdateGamepads", def() thin -> None]()()
...
def get_gamepad_string_for_type(
    ...
    return _get_dylib_function[
        ...
        def(type: GamepadType) thin -> Ptr[c_char, ImmutAnyOrigin],
    ]()(type)


def get_gamepad_axis_from_string(var str: String) raises -> GamepadAxis:
...
def get_gamepad_string_for_axis(
    ...
    return _get_dylib_function[
        ...
        def(axis: GamepadAxis) thin -> Ptr[c_char, ImmutAnyOrigin],
    ]()(axis)


def gamepad_has_axis(
    ...
    return _get_dylib_function[
        lib,
        "SDL_GamepadHasAxis",
        def(gamepad: Ptr[Gamepad, MutAnyOrigin], axis: GamepadAxis) thin -> Bool,
    ]()(gamepad, axis)


def get_gamepad_axis(
    gamepad: Ptr[Gamepad, MutAnyOrigin], axis: GamepadAxis
) raises -> Int16:
    ...
    return _get_dylib_function[
        lib,
        "SDL_GetGamepadAxis",
        def(gamepad: Ptr[Gamepad, MutAnyOrigin], axis: GamepadAxis) thin -> Int16,
    ]()(gamepad, axis)


def get_gamepad_button_from_string(var str: String) raises -> GamepadButton:
...
def get_gamepad_string_for_button(
    ...
    return _get_dylib_function[
        ...
        def(button: GamepadButton) thin -> Ptr[c_char, ImmutAnyOrigin],
    ]()(button)


def gamepad_has_button(
    ...
    return _get_dylib_function[
        ...
        def(gamepad: Ptr[Gamepad, MutAnyOrigin], button: GamepadButton) thin -> Bool,
    ]()(gamepad, button)


def get_gamepad_button(
    gamepad: Ptr[Gamepad, MutAnyOrigin], button: GamepadButton
) raises -> Bool:
...
def get_gamepad_button_label_for_type(
    type: GamepadType, button: GamepadButton
) raises -> GamepadButtonLabel:
    ...
    return _get_dylib_function[
        ...
        def(type: GamepadType, button: GamepadButton) thin -> GamepadButtonLabel,
    ]()(type, button)


def get_gamepad_button_label(
    gamepad: Ptr[Gamepad, MutAnyOrigin], button: GamepadButton
) raises -> GamepadButtonLabel:
    """Get the label of a button on a gamepad.
    ...
    return _get_dylib_function[
        ...
        def(
            gamepad: Ptr[Gamepad, MutAnyOrigin], button: GamepadButton
        ) thin -> GamepadButtonLabel,
    ]()(gamepad, button)


def get_num_gamepad_touchpads(
    gamepad: Ptr[Gamepad, MutAnyOrigin]
) raises -> c_int:
...
def get_num_gamepad_touchpad_fingers(
    gamepad: Ptr[Gamepad, MutAnyOrigin], touchpad: c_int
) raises -> c_int:
    ...
    return _get_dylib_function[
        ...
        def(gamepad: Ptr[Gamepad, MutAnyOrigin], touchpad: c_int) thin -> c_int,
    ]()(gamepad, touchpad)


def get_gamepad_touchpad_finger(
    gamepad: Ptr[Gamepad, MutAnyOrigin],
    touchpad: c_int,
    finger: c_int,
    ...
    pressure: Ptr[c_float, MutAnyOrigin],
) raises:
...
def gamepad_has_sensor(
    gamepad: Ptr[Gamepad, MutAnyOrigin], type: SensorType
) raises -> Bool:
    ...
    return _get_dylib_function[
        ...
        def(gamepad: Ptr[Gamepad, MutAnyOrigin], type: SensorType) thin -> Bool,
    ]()(gamepad, type)


def set_gamepad_sensor_enabled(
...
def get_gamepad_sensor_data_rate(
    gamepad: Ptr[Gamepad, MutAnyOrigin], type: SensorType
) raises -> c_float:
    ...
    return _get_dylib_function[
        ...
        def(gamepad: Ptr[Gamepad, MutAnyOrigin], type: SensorType) thin -> c_float,
    ]()(gamepad, type)


def get_gamepad_sensor_data(
    gamepad: Ptr[Gamepad, MutAnyOrigin],
    type: SensorType,
...
def close_gamepad(gamepad: Ptr[Gamepad, MutAnyOrigin]) raises -> None:
    ...
    return _get_dylib_function[
        lib,
        "SDL_CloseGamepad",
        def(gamepad: Ptr[Gamepad, MutAnyOrigin]) thin -> None,
    ]()(gamepad)


def get_gamepad_apple_sf_symbols_name_for_button(
    gamepad: Ptr[Gamepad, MutAnyOrigin], button: GamepadButton
) raises -> Ptr[c_char, ImmutAnyOrigin]:
...
def get_gamepad_apple_sf_symbols_name_for_axis(
    gamepad: Ptr[Gamepad, MutAnyOrigin], axis: GamepadAxis
) raises -> Ptr[c_char, ImmutAnyOrigin]:
