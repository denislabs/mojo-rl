...
comptime GLContext = Ptr[NoneType, MutAnyOrigin]
"""An opaque handle to an OpenGL context.

Docs: https://wiki.libsdl.org/SDL3/GLContext.
"""

comptime EGLDisplay = Ptr[NoneType, MutAnyOrigin]
"""Opaque type for an EGL display.

Docs: https://wiki.libsdl.org/SDL3/SDL_EGLDisplay.
"""
comptime EGLConfig = Ptr[NoneType, MutAnyOrigin]
"""Opaque type for an EGL config.

Docs: https://wiki.libsdl.org/SDL3/SDL_EGLConfig.
"""
comptime EGLSurface = Ptr[NoneType, MutAnyOrigin]
...
comptime EGLAttribArrayCallback = Ptr[
    def(userdata: Ptr[NoneType, MutAnyOrigin]) thin -> EGLAttrib, MutAnyOrigin
]
...
def get_num_video_drivers() raises -> c_int:
    ...
    return _get_dylib_function[
        lib, "SDL_GetNumVideoDrivers", def() thin -> c_int
    ]()()
...
def get_current_video_driver() raises -> Ptr[c_char, ImmutAnyOrigin]:
    ...
    return _get_dylib_function[
        lib, "SDL_GetCurrentVideoDriver", def() thin -> Ptr[c_char, ImmutAnyOrigin]
    ]()()
...
def get_system_theme() raises -> SystemTheme:
    ...
    return _get_dylib_function[
        lib, "SDL_GetSystemTheme", def() thin -> SystemTheme
    ]()()
...
def get_primary_display() raises -> DisplayID:
    ...
    return _get_dylib_function[
        lib, "SDL_GetPrimaryDisplay", def() thin -> DisplayID
    ]()()
...
def get_display_properties(display_id: DisplayID) raises -> PropertiesID:
    ...
    return _get_dylib_function[
        ...
        def(display_id: DisplayID) thin -> PropertiesID,
    ]()(display_id)
...
def get_natural_display_orientation(
    ...
    return _get_dylib_function[
        ...
        def(display_id: DisplayID) thin -> DisplayOrientation,
    ]()(display_id)
...
def get_display_content_scale(display_id: DisplayID) raises -> c_float:
    ...
    return _get_dylib_function[
        ...
        def(display_id: DisplayID) thin -> c_float,
    ]()(display_id)
...
def get_fullscreen_display_modes(
    ...
    return _get_dylib_function[
        ...
        def(
            display_id: DisplayID, count: Ptr[c_int, MutAnyOrigin]
        ) thin -> Ptr[Ptr[DisplayMode, MutAnyOrigin], MutAnyOrigin],
    ]()(display_id, count)
...
def get_display_for_point(
    ...
    return _get_dylib_function[
        ...
        def(point: Ptr[Point, ImmutAnyOrigin]) thin -> DisplayID,
    ]()(point)
...
def get_display_for_rect(rect: Ptr[Rect, ImmutAnyOrigin]) raises -> DisplayID:
    ...
    return _get_dylib_function[
        ...
        def(rect: Ptr[Rect, ImmutAnyOrigin]) thin -> DisplayID,
    ]()(rect)
...
def get_display_for_window(
    ...
    return _get_dylib_function[
        ...
        def(window: Ptr[Window, MutAnyOrigin]) thin -> DisplayID,
    ]()(window)
...
def get_window_pixel_density(
    ...
    return _get_dylib_function[
        ...
        def(window: Ptr[Window, MutAnyOrigin]) thin -> c_float,
    ]()(window)
...
def get_window_fullscreen_mode(
    ...
    return _get_dylib_function[
        ...
        def(
            window: Ptr[Window, MutAnyOrigin]
        ) thin -> Ptr[DisplayMode, ImmutAnyOrigin],
    ]()(window)
...
def get_window_pixel_format(
    ...
    return _get_dylib_function[
        ...
        def(window: Ptr[Window, MutAnyOrigin]) thin -> PixelFormat,
    ]()(window)
...
def get_window_id(window: Ptr[Window, MutAnyOrigin]) raises -> WindowID:
    ...
    return _get_dylib_function[
        lib,
        "SDL_GetWindowID",
        def(window: Ptr[Window, MutAnyOrigin]) thin -> WindowID,
    ]()(window)
...
def get_window_from_id(id: WindowID) raises -> Ptr[Window, MutAnyOrigin]:
    ...
    return _get_dylib_function[
        lib,
        "SDL_GetWindowFromID",
        def(id: WindowID) thin -> Ptr[Window, MutAnyOrigin],
    ]()(id)
...
def get_window_properties(
    ...
    return _get_dylib_function[
        ...
        def(window: Ptr[Window, MutAnyOrigin]) thin -> PropertiesID,
    ]()(window)
...
def get_window_flags(window: Ptr[Window, MutAnyOrigin]) raises -> WindowFlags:
    ...
    return _get_dylib_function[
        lib,
        "SDL_GetWindowFlags",
        def(window: Ptr[Window, MutAnyOrigin]) thin -> WindowFlags,
    ]()(window)
...
def get_window_title(
    ...
    return _get_dylib_function[
        lib,
        "SDL_GetWindowTitle",
        def(window: Ptr[Window, MutAnyOrigin]) thin -> Ptr[c_char, ImmutAnyOrigin],
    ]()(window)
...
def get_window_borders_size(
    ...
    bottom: Ptr[c_int, MutAnyOrigin],
    right: Ptr[c_int, MutAnyOrigin],
) raises:
...
def get_grabbed_window() raises -> Ptr[Window, MutAnyOrigin]:
    ...
    return _get_dylib_function[
        lib, "SDL_GetGrabbedWindow", def() thin -> Ptr[Window, MutAnyOrigin]
    ]()()
...
def screen_saver_enabled() raises -> Bool:
    ...
    return _get_dylib_function[
        lib, "SDL_ScreenSaverEnabled", def() thin -> Bool
    ]()()
...
def gl_get_proc_address(var proc: String) raises -> def() thin -> None:
...
def gl_unload_library() raises -> None:
    ...
    return _get_dylib_function[lib, "SDL_GL_UnloadLibrary", def() thin -> None]()()
...
def gl_create_context(window: Ptr[Window, MutAnyOrigin]) raises -> GLContext:
    ...
    return _get_dylib_function[
        ...
        def(window: Ptr[Window, MutAnyOrigin]) thin -> GLContext,
    ]()(window)
...
def gl_get_current_context() raises -> GLContext:
    ...
    return _get_dylib_function[
        lib, "SDL_GL_GetCurrentContext", def() thin -> GLContext
    ]()()
...
def egl_get_current_config() raises -> EGLConfig:
    ...
    return _get_dylib_function[
        lib, "SDL_EGL_GetCurrentConfig", def() thin -> EGLConfig
    ]()()
