...
from mojo_rl.tasks.libero_envs.budgets import LIBERO_KITCHEN_SCENE6_MAX_CONTACTS
from mojo_rl.tasks.libero_envs.libero_kitchen_scene6_dims import LIBERO_KITCHEN_SCENE6_DIMS
...
comptime LiberoKitchenScene6Model = ModelDefFromXML[
    xml_path="mojo_rl/tasks/scenes/libero_kitchen_scene6.xml",
    nbody=_pm.NBODY,
    njoint=_pm.NJOINT,
    nq=_pm.NQ,
    nv=_pm.NV,
