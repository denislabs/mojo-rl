...
from mojo_rl.tasks.libero_envs.budgets import LIBERO_STUDY_SCENE1_MAX_CONTACTS
from mojo_rl.tasks.libero_envs.libero_study_scene1_dims import LIBERO_STUDY_SCENE1_DIMS
...
comptime LiberoStudyScene1Model = ModelDefFromXML[
    xml_path="mojo_rl/tasks/scenes/libero_study_scene1.xml",
    nbody=_pm.NBODY,
    njoint=_pm.NJOINT,
    nq=_pm.NQ,
    nv=_pm.NV,
