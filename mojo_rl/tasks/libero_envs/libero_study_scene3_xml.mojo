...
from mojo_rl.tasks.libero_envs.budgets import LIBERO_STUDY_SCENE3_MAX_CONTACTS
from mojo_rl.tasks.libero_envs.libero_study_scene3_dims import LIBERO_STUDY_SCENE3_DIMS
...
comptime LiberoStudyScene3Model = ModelDefFromXML[
    xml_path="mojo_rl/tasks/scenes/libero_study_scene3.xml",
    nbody=_pm.NBODY,
    njoint=_pm.NJOINT,
    nq=_pm.NQ,
    nv=_pm.NV,
