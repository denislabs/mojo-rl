...
from mojo_rl.core.kv import kv_lines, split_on
...
def load_state_remap(family: String) raises -> StateRemap:
    """`mojo_rl/tasks/libero/state_remap_<family>.kv`, refusing a partial table.
    ...
    """
    var path = String("mojo_rl/tasks/libero/state_remap_") + family + ".kv"
    var text: String
