...
From `mojo_rl/tasks/families/libero_living_room_scene3.family`,
`mojo_rl/tasks/scenes/libero_living_room_scene3.xml` and forward kinematics on it.
6 free slots, 7 regions, 1 of them moving.
