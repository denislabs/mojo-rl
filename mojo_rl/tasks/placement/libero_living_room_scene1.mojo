...
From `mojo_rl/tasks/families/libero_living_room_scene1.family`,
`mojo_rl/tasks/scenes/libero_living_room_scene1.xml` and forward kinematics on it.
5 free slots, 6 regions, 1 of them moving.
