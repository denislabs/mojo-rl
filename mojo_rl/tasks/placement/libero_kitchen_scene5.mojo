...
From `mojo_rl/tasks/families/libero_kitchen_scene5.family`,
`mojo_rl/tasks/scenes/libero_kitchen_scene5.xml` and forward kinematics on it.
3 free slots, 8 regions, 3 of them moving.
