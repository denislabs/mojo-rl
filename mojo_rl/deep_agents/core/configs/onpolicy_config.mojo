...
from ..strategies.policy_gradient import (
    PolicyGradient,
    VanillaPG,
    ClippedSurrogate,
    AutodiffVanillaPG,
...
from ..strategies.epoch_schedule import EpochSchedule, SinglePass, MultiEpochMinibatch
...
# AutodiffA2CConfig is now just an alias for A2CConfig (which uses autodiff by default)
comptime AutodiffA2CConfig = A2CConfig


# AutodiffContinuousPPOConfig is now just an alias for ContinuousPPOConfig (which uses autodiff by default)
comptime AutodiffContinuousPPOConfig = ContinuousPPOConfig
