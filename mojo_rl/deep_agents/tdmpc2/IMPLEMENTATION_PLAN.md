...
┌────────────────┬─────┬─────┬──────┬──────┬──────┐                                                                             
│     Param      │ 1M  │ 5M  │ 19M  │ 48M  │ 317M │                                                                             
├────────────────┼─────┼─────┼──────┼──────┼──────┤                                                                             
│ enc_dim        │ 256 │ 256 │ 1024 │ 1792 │ 4096 │                                                                             
├────────────────┼─────┼─────┼──────┼──────┼──────┤                                                                             
│ mlp_dim        │ 384 │ 512 │ 1024 │ 1792 │ 4096 │                                                                             
├────────────────┼─────┼─────┼──────┼──────┼──────┤                                                                             
│ latent_dim     │ 128 │ 512 │ 768  │ 768  │ 1376 │                                                                             
├────────────────┼─────┼─────┼──────┼──────┼──────┤                                                                             
│ num_enc_layers │ 2   │ 2   │ 3    │ 4    │ 5    │                                                                             
├────────────────┼─────┼─────┼──────┼──────┼──────┤                                                                             
│ num_q          │ 2   │ 5   │ 5    │ 5    │ 8    │
├────────────────┼─────┼─────┼──────┼──────┼──────┤
│ num_bins       │ 101 │ 101 │ 101  │ 101  │ 101  │
└────────────────┴─────┴─────┴──────┴──────┴──────┘


========== TDMPC2 GPU Timing Summary ==========
Total measured time: 545945.113341 ms over 1741 training iterations
Avg per training iter: 313.58134023032744 ms
─────────────────────────────────────────────────
Data collection:     483934.620069 ms ( 88.64162499916581 %)
Replay sampling:     300.325982 ms ( 0.05501028851821867 %)
Batch upload:        28.065936 ms ( 0.005140798097494808 %)
TD targets:          4766.058762 ms ( 0.8729922927294518 %)
WM gradient (Hx):    42673.347895 ms ( 7.816417228071426 %)
WM optimizer:        270.386035 ms ( 0.049526230456634845 %)
Policy update:       13934.490553 ms ( 2.5523610730253847 %)
...
─────────────────────────────────────────────────
Data collection:     484120.049996 ms ( 88.66541677306353 %)
Replay sampling:     6.654466 ms ( 0.0012187493604056596 %)
Batch upload:        0.049999 ms ( 9.15719597499222e-06 %)
TD targets:          4832.657257 ms ( 0.8850894934362155 %)
WM gradient (Hx):    42657.868586 ms ( 7.812685504059407 %)
WM optimizer:        279.419899 ms ( 0.05117507899069047 %)
...
─────────────────────────────────────────────────
Data collection:     483781.294232 ms ( 88.66800816165618 %)
Replay sampling:     8.646972 ms ( 0.0015848272618451686 %)
Batch upload:        0.048189 ms ( 8.832136951646985e-06 %)
TD targets:          4838.454591 ms ( 0.886797683746023 %)
Train (BPTT+optim+policy+soft):  56981.302149 ms ( 10.443600495199002 %)
=================================================
