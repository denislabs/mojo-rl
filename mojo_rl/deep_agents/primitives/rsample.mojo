...
`nn/loss/squashed_gaussian.mojo`.
    ...
    def forward[
        ...
        comptime if target == "cpu":
            ...
            var act_lt = LayoutTensor[
                DT,
                Layout.row_major(BATCH, Self.ACT),
                MutAnyOrigin,
            ](act_p)
            ...
            var out_lt = LayoutTensor[
                DT,
                Layout.row_major(BATCH, Self.ACT + 1),
                MutAnyOrigin,
            ](out_p)
