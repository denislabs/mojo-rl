...
(audit P1 finding):
  ...
  1. `nn/primitives/rsample.mojo` — as `RSample[ACT]` Module.
  2. `nn/loss/sac_actor_loss.mojo` — as free functions (basically the
     same as here).
  3. `nn/loss/sac_actor_loss.mojo` — composes the Module form.
