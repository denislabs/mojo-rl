"""PhysicsLayoutStrided - Compile-time layout for flat 2D strided buffers.
...
Unlike PhysicsLayout which uses 3D structured tensors [BATCH, NUM_BODIES, BODY_STATE_SIZE],
PhysicsLayoutStrided packs all physics data per-environment in a single row:
...
Example:
    ```mojo
    from physics_gpu.layout_strided import PhysicsLayoutStrided

    # Define layout for LunarLander: 3 bodies, 2 joints, 16 terrain edges
    alias Layout = PhysicsLayoutStrided[
        NUM_BODIES=3,
        MAX_CONTACTS=8,
        MAX_JOINTS=2,
...
comptime LunarLanderLayoutStrided = PhysicsLayoutStrided[
    NUM_BODIES=3,
    MAX_CONTACTS=8,
    MAX_JOINTS=2,
    MAX_TERRAIN_EDGES=16,
...
comptime CartPoleLayoutStrided = PhysicsLayoutStrided[
    NUM_BODIES=2,
    MAX_CONTACTS=4,
    MAX_JOINTS=1,
    MAX_TERRAIN_EDGES=2,
...
comptime AcrobotLayoutStrided = PhysicsLayoutStrided[
    NUM_BODIES=2,
    MAX_CONTACTS=0,
    MAX_JOINTS=1,
    MAX_TERRAIN_EDGES=0,
