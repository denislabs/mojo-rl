...
def main() raises:
    ...
    var z1: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](ACT_DIM)
    var a1: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](ACT_DIM)
    var lp1: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](1)

    # ── Scratch (minibatch) ────────────────────────────────────────────
    var mb_s: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](BATCH * OBS_DIM)
    var mb_a: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](BATCH * ACT_DIM)
    var mb_r: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](BATCH)
    var mb_sp: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](BATCH * OBS_DIM)
    var mb_d: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](BATCH)
    var mb_sa: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](BATCH * SA_DIM)
    var mb_ao_s: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](BATCH * 2 * ACT_DIM)
    var mb_ao_sp: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](BATCH * 2 * ACT_DIM)
    var mb_z_s: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](BATCH * ACT_DIM)
    var mb_z_sp: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](BATCH * ACT_DIM)
    var mb_act_s: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](BATCH * ACT_DIM)
    var mb_act_sp: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](BATCH * ACT_DIM)
    var mb_lp_s: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](BATCH)
    var mb_lp_sp: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](BATCH)
    var mb_q1: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](BATCH * 1)
    var mb_q2: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](BATCH * 1)
    var mb_q1_tgt: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](BATCH * 1)
    var mb_q2_tgt: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](BATCH * 1)
    var mb_y: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](BATCH * 1)
    var mb_grad_q1: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](BATCH * 1)
    var mb_grad_q2: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](BATCH * 1)
    var mb_grad_sa1: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](BATCH * SA_DIM)
    var mb_grad_sa2: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](BATCH * SA_DIM)
    var mb_grad_action: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](BATCH * ACT_DIM)
    var mb_grad_ao: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](BATCH * 2 * ACT_DIM)
    var mb_grad_obs_unused: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](BATCH * OBS_DIM)
    var min_q_buf: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](BATCH)

    # Single-transition scratch for buf.add (action + next-obs).
    var act_scratch: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](ACT_DIM)
    var sp_scratch: UnsafePointer[Scalar[DT], MutAnyOrigin] = alloc[Scalar[DT]](OBS_DIM)
    ...
    while step < TOTAL_TIMESTEPS:
        ...
        actor.forward["cpu", BATCH](mb_sp_t, output=mb_ao_sp_t)
        ...
        pair1.target_net.forward["cpu", BATCH](mb_sa_t, output=mb_q1_tgt_t)
        pair2.target_net.forward["cpu", BATCH](mb_sa_t, output=mb_q2_tgt_t)
        ...
        pair1.online.forward["cpu", BATCH](mb_sa_t, output=mb_q1_t)
        pair2.online.forward["cpu", BATCH](mb_sa_t, output=mb_q2_t)
        ...
        actor.forward["cpu", BATCH](mb_s_t, output=mb_ao_s_t)
