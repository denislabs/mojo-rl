...
Same algorithm and hyperparameters as `pendulum_sac_nn2_driver.mojo`;
...
Run:
    pixi run mojo run -I . examples/pendulum/pendulum_sac_nn2_agent.mojo
"""
...
def main() raises:
    seed(42)
    print("=" * 70)
    print("nn2 SAC (SACAgent facade) — Pendulum V1 (CPU)")
    print("=" * 70)
