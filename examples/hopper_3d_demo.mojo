"""Hopper3D Demo - Test the Hopper3D environment with random actions.

This demo shows:
- Creating a Hopper3D environment
...
fn run_episode(
    mut env: Hopper3D, render: Bool = False, max_steps: Int = 500
) raises -> Float64:
    ...
    while not done and step < max_steps:
        ...
        action.append(random_float64() * 2.0 - 1.0)  # hip
        action.append(random_float64() * 2.0 - 1.0)  # knee
        action.append(random_float64() * 2.0 - 1.0)  # ankle
...
fn main() raises:
    print("=== Hopper3D Environment Demo ===")
    print()
    ...
    var reward = run_episode(env, render=True, max_steps=1000)
