"""nn2 LeNet-style CNN on MNIST (GPU).

Port of `examples/nn/conv2d/conv2d_mnist_training_gpu.mojo` to nn2.

Exercises the nn2 Conv2D + MaxPool2D + Flatten + Linear stack end-to-end
...
Run (Apple Metal):
    pixi run -e apple mojo run -I . examples/nn2/conv2d/conv2d_mnist_training_gpu.mojo
"""
