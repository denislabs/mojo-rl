...
GPU successor of `sac_ant_nn2_agent.mojo` and counterpart of the legacy
...
Run:
    pixi run -e apple  mojo run -I . examples/ant/sac_ant_nn2_agent_gpu.mojo  # Apple Silicon
    pixi run -e nvidia mojo run -I . examples/ant/sac_ant_nn2_agent_gpu.mojo  # NVIDIA GPU
"""
...
def main() raises:
    seed(42)
    print("=" * 70)
    print("SAC (deep_agents2) — Ant GPU (multi-env) + logger")
    print("=" * 70)
