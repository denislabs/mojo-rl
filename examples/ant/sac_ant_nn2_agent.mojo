...
Ant counterpart of `examples/half_cheetah/sac_half_cheetah_nn2_agent.mojo`.
...
Run:
    pixi run mojo run -I . examples/ant/sac_ant_nn2_agent.mojo
"""
...
comptime CHECKPOINT_PATH = "sac_ant_nn2.ckpt"
...
def main() raises:
    seed(42)
    print("=" * 70)
    print("SAC (deep_agents2) — Ant CPU + checkpoints + logger")
    print("=" * 70)
