"""CPU evaluation for SAC on Ant.

This evaluates a trained SAC agent using CPU inference on the Ant
...
Run with:
    pixi run mojo run -I . examples/ant/sac_ant_eval_cpu.mojo
"""
...
def main() raises:
    ...
    try:
        agent.load_checkpoint("sac_ant.ckpt")
        ...
        print(
            ...
            " examples/ant/sac_ant_training_gpu.mojo"
        )
        return
    ...
    print()
    print("-" * 70)
    print("CPU EVALUATION SUMMARY - Ant (SAC)")
    print("-" * 70)
    print("Episodes:", NUM_EPISODES)
