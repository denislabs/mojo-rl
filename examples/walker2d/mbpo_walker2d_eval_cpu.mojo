"""CPU evaluation for MBPO on Walker2d.

This evaluates a trained MBPO agent using CPU inference on the Walker2d
...
Run with:
    pixi run mojo run -I . examples/walker2d/mbpo_walker2d_eval_cpu.mojo
"""
...
def main() raises:
    ...
    var agent = MBPOAgent[MBPOWalker2dConfig](
        gamma=0.99,
        tau=0.005,
        action_scale=1.0,
        alpha=0.2,
    ...
    try:
        agent.load_checkpoint("mbpo_walker2d.ckpt")
        ...
        print(
            ...
            " examples/walker2d/mbpo_walker2d_training_gpu.mojo"
        )
        return
    ...
    print()
    print("-" * 70)
    print("CPU EVALUATION SUMMARY - Walker2d (MBPO)")
    print("-" * 70)
    print("Episodes:", NUM_EPISODES)
