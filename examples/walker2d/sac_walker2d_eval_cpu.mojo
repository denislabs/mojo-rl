"""CPU evaluation for SAC on Walker2d.

This evaluates a trained SAC agent using CPU inference on the Walker2d
...
Run with:
    pixi run mojo run -I . examples/walker2d/sac_walker2d_eval_cpu.mojo
"""
...
def main() raises:
    ...
    try:
        agent.load_checkpoint("sac_walker2d.ckpt")
    ...
    print()
    print("-" * 70)
    print("CPU EVALUATION SUMMARY - Walker2d (SAC)")
    print("-" * 70)
    print("Episodes:", NUM_EPISODES)
