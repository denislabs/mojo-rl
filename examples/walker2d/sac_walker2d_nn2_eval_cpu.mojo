...
Loads the one-file `nn2-ckpt v2` checkpoint written by either Walker2d SAC
trainer (`sac_walker2d_nn2_agent.mojo` CPU or `sac_walker2d_nn2_agent_gpu.mojo`
...
(`deep_agents2.sac`), so the actor/critic architecture — and therefore the
