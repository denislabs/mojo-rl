"""TD3 Agent GPU Training on Hopper.

This trains the TD3 (Twin Delayed DDPG) agent on the Hopper environment
...
Run with:
    pixi run -e apple mojo run -I . examples/hopper/td3_hopper_training_gpu.mojo    # Apple Silicon
    pixi run -e nvidia mojo run -I . examples/hopper/td3_hopper_training_gpu.mojo   # NVIDIA GPU
"""
...
def main() raises:
    seed(42)
    print("=" * 70)
    print("TD3 Agent GPU Training on Hopper")
    print("=" * 70)
    print()
    ...
    with DeviceContext() as ctx:
        var agent = DeepTD3Agent[
            ...
            checkpoint_path="td3_hopper.ckpt",
        )
