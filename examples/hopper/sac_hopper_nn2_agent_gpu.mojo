...
GPU successor of `sac_hopper_nn2_agent.mojo` (the CPU nn2 example) and direct
...
Run:
    pixi run -e apple  mojo run -I . examples/hopper/sac_hopper_nn2_agent_gpu.mojo  # Apple Silicon
    pixi run -e nvidia mojo run -I . examples/hopper/sac_hopper_nn2_agent_gpu.mojo  # NVIDIA GPU
"""
...
# =============================================================================
# Architecture (matches the CPU nn2 / legacy DeepSACAgent hopper runs)
# =============================================================================
...
def main() raises:
    seed(42)
    print("=" * 70)
    print("SAC (deep_agents2) — Hopper GPU (multi-env) + logger")
    print("=" * 70)
