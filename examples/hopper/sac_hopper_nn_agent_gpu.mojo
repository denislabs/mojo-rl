...
GPU successor of `sac_hopper_nn_agent.mojo` (the CPU nn example) and direct
...
Run:
    pixi run -e apple  mojo run -I . examples/hopper/sac_hopper_nn_agent_gpu.mojo  # Apple Silicon
    pixi run -e nvidia mojo run -I . examples/hopper/sac_hopper_nn_agent_gpu.mojo  # NVIDIA GPU
"""
