"""Continuous PPO via deep_agents2 PPOAgent on LunarLanderContinuous (CPU).

nn2 port of the legacy `ppo_lunar_continuous_gpu.mojo`. LunarLander conforms
...
Run with: pixi run mojo run -I . examples/lunar_lander/lunar_lander_ppo_continuous_nn2_agent.mojo
"""
...
def main() raises:
    seed(42)
    print("=" * 60)
    print("nn2 PPO (PPOAgent facade) — LunarLanderContinuous (CPU)")
    print("=" * 60)
