"""SAC Agent CPU Training on Gymnasium LunarLander (Continuous).

Trains SAC on the Gymnasium LunarLanderContinuous-v3 environment:
...
Run with:
    pixi run mojo run -I . examples/lunar_lander/sac_gym_lunar_lander_training_cpu.mojo
"""
...
from mojo_rl.envs.gymnasium import GymLunarLanderContinuousEnv
...
def main() raises:
    seed(42)
    print("=" * 70)
    print("SAC Agent CPU Training on Gymnasium LunarLander (Continuous)")
    print("=" * 70)
    print()

    var env = GymLunarLanderContinuousEnv()
    ...
    print("Environment: Gymnasium LunarLander-v3 Continuous (CPU)")
    ...
    var metrics = agent.train(
        ...
        verbose=True,
        print_every=10_000,
        environment_name="GymLunarLander",
    )
    ...
    print()
    print("=" * 70)
    print("Gymnasium LunarLander CPU Training Complete")
    print("=" * 70)
    print()
    print("Total steps:", NUM_STEPS)
