"""DQN via deep_agents2 DQNAgent on LunarLander (discrete, CPU).

nn2 port of the legacy `lunar_lander_dqn.mojo`. LunarLander conforms to
...
Run with: pixi run mojo run -I . examples/lunar_lander/lunar_lander_dqn_nn2_agent.mojo
"""
...
from mojo_rl.deep_agents2.dqn import DQNAgent
...
def main() raises:
    seed(42)
    print("=" * 60)
    print("nn2 DQN (DQNAgent facade) — LunarLander (CPU)")
    print("=" * 60)
