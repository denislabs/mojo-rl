"""Train SAC on BipedalWalker (CPU), then record a GIF of the trained agent.

Run with:
    pixi run mojo run -I . examples/sac_bipedal_walker_demo_gif.mojo
"""
...
def main() raises:
    ...
    # ==========================================================================
    print("=" * 60)
    print("  BipedalWalker SAC — Train + GIF Export")
    print("=" * 60)
    print()
    ...
    _ = env.init_renderer()
    env.start_recording("gifs/bipedal_walker_sac_trained.gif", fps=30, skip=4)
    ...
    print()
    print("Saved: gifs/bipedal_walker_sac_trained.gif")
    print("Done!")
