...
GPU successor of `sac_inverted_double_pendulum_nn2_agent.mojo` and counterpart
...
Run:
    pixi run -e apple  mojo run -I . examples/inverted_double_pendulum/sac_inverted_double_pendulum_nn2_agent_gpu.mojo  # Apple Silicon
    pixi run -e nvidia mojo run -I . examples/inverted_double_pendulum/sac_inverted_double_pendulum_nn2_agent_gpu.mojo  # NVIDIA GPU
"""
...
def main() raises:
    seed(42)
    print("=" * 70)
    print("SAC (deep_agents2) — InvertedDoublePendulum GPU (multi-env) + logger")
    print("=" * 70)
