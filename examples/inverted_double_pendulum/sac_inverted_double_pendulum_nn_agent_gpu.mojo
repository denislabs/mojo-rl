...
GPU successor of `sac_inverted_double_pendulum_nn_agent.mojo` and counterpart
...
Run:
    pixi run -e apple  mojo run -I . examples/inverted_double_pendulum/sac_inverted_double_pendulum_nn_agent_gpu.mojo  # Apple Silicon
    pixi run -e nvidia mojo run -I . examples/inverted_double_pendulum/sac_inverted_double_pendulum_nn_agent_gpu.mojo  # NVIDIA GPU
"""
