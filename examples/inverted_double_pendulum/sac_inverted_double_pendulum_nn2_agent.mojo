...
Run:
    pixi run mojo run -I . examples/inverted_double_pendulum/sac_inverted_double_pendulum_nn2_agent.mojo
"""
...
comptime CHECKPOINT_PATH = "sac_inverted_double_pendulum_nn2.ckpt"
...
def main() raises:
    seed(42)
    print("=" * 70)
    print("SAC (deep_agents2) — InvertedDoublePendulum CPU + checkpoints + logger")
    print("=" * 70)
