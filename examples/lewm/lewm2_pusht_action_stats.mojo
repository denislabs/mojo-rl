"""LeWM (nn2) — PushT offline ACTION statistics probe.
...
Run (NVIDIA box has the dataset):
  pixi run -e nvidia mojo run -I . examples/lewm/lewm2_pusht_action_stats.mojo
"""
...
def main() raises:
    print("=" * 70)
    print("LeWM nn2 — PushT offline action statistics")
    print("=" * 70)
    rng_seed(1)
