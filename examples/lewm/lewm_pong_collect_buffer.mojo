...
buffer (LWMP v1, see `noeira/envs/arcade_games/pong/offline_buffer.mojo`).
...
from noeira.envs.arcade_games.pong.pong import S_BALL_Y, S_PADDLE_Y
from noeira.envs.arcade_games.core.gpu_env import ArcadeGameAction
