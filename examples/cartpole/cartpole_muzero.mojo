...
fn main():
    ...
    comptime Config = MuZeroMLPConfig[4, 2, LATENT=128, HIDDEN=128, BINS=51, SIMS=25]
    ...
    _ = agent.train[CartPoleEnv[DType.float64]](
        env, total_timesteps=20000, train_every=2,
        seed_episodes=10, print_every=50, warmup_steps=500,
        use_reanalyze=True,
    )
