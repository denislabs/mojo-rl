...
Run:
    pixi run mojo run -I . examples/inverted_pendulum/sac_inverted_pendulum_training.mojo
"""
...
def main() raises:
    ...
    var run = RunContext(
        ...
        driver=String("examples/inverted_pendulum/sac_inverted_pendulum_training.mojo"),
        slug=String("sac-inverted-pendulum"),
        env=String("builtin:mujoco/inverted_pendulum"),
    )
