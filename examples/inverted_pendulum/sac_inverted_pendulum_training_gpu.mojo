...
from noeira.envs.inverted_pendulum.inverted_pendulum_config import (
...
comptime OBS_DIM = InvertedPendulumModel.OBS_DIM  # 4
comptime ACT_DIM = InvertedPendulumModel.ACTION_DIM  # 1
comptime HIDDEN = 256
