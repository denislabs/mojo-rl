...
|---|---|---|
| `test_cartpole_gpu.mojo` | imports the removed `noeira.envs.cartpole_gpu` module (GPU kernels were folded into `envs/cartpole.mojo`) | `tests/` CartPole GPU tests + `examples/cartpole/` |
