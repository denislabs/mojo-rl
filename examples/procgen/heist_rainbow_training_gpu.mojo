...
def main() raises:
    ...
    with DeviceContext() as ctx:
        ...
        var run = RunContext(
            ...
            driver=String("examples/procgen/heist_rainbow_training_gpu.mojo"),
            slug=String("rainbow-heist"),
            env=String("builtin:procgen/heist"),
        )
        ...
        try:
            var _ret = agent.train_cpu_batched[
                BatchedHeist, N_ENVS, N_STEP, RunLogger
            ](
                env,
                NUM_STEPS,
                rng_seed=UInt64(42),
