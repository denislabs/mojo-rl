...
from mojo_rl.envs.procgen.games import CoinrunGymEnv, CoinrunAssets
from mojo_rl.envs.procgen.games.coinrun import DIST_EASY
...
comptime CKPT_PATH = "checkpoints/rainbow_procgen_coinrun_pixel.ckpt"
...
def main() raises:
    ...
    with DeviceContext() as ctx:
        ...
        var logger = RemoteLogger(
            server_url=url,
            run_name="Rainbow Procgen Coinrun Pixel GPU",
            buffer_size=64,
            api_key=api_key,
        )
        ...
        try:
            var _ret = agent.train_cpu_batched[
                BatchedCoinrun, N_ENVS, N_STEP, RemoteLogger
            ](
                env,
                NUM_STEPS,
                rng_seed=UInt64(42),
