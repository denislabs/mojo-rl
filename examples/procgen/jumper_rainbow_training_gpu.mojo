...
from mojo_rl.envs.procgen.games import JumperGymEnv, JumperAssets
from mojo_rl.envs.procgen.games.jumper import DIST_EASY
...
comptime CKPT_PATH = "checkpoints/rainbow_procgen_jumper_pixel.ckpt"
...
def main() raises:
    ...
    with DeviceContext() as ctx:
        ...
        var logger = RemoteLogger(
            server_url=url,
            run_name="Rainbow Procgen Jumper Pixel GPU",
            buffer_size=64,
            api_key=api_key,
        )
        ...
        try:
            var _ret = agent.train_cpu_batched[
                BatchedJumper, N_ENVS, N_STEP, RemoteLogger
            ](
                env,
                NUM_STEPS,
                rng_seed=UInt64(42),
