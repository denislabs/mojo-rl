...
Port of `examples/nn/resnet/resnet20_cifar10_training_gpu.mojo` to nn.
...
Built entirely from the nn composites added for the zero series:
...
from mojo_rl.nn.combinators import Sequential, Repeat
