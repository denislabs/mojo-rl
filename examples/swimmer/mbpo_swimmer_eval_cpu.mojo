...
def main() raises:
    ...
    var agent = MBPOAgent[MBPOSwimmerConfig](
        gamma=0.999,
        tau=0.005,
        action_scale=1.0,
        alpha=0.2,
    ...
    try:
        agent.load_checkpoint("mbpo_swimmer.ckpt")
        ...
        print(
            ...
            " examples/swimmer/mbpo_swimmer_training_gpu.mojo"
        )
        return
    ...
    print()
    print("-" * 70)
    print("CPU EVALUATION SUMMARY - Swimmer (MBPO)")
    print("-" * 70)
    print("Episodes:", NUM_EPISODES)
