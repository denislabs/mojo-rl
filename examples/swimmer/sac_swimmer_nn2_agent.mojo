...
Swimmer counterpart of `examples/half_cheetah/sac_half_cheetah_nn2_agent.mojo`.
...
Run:
    pixi run mojo run -I . examples/swimmer/sac_swimmer_nn2_agent.mojo
"""
...
comptime CHECKPOINT_PATH = "sac_swimmer_nn2.ckpt"
...
def main() raises:
    seed(42)
    print("=" * 70)
    print("SAC (deep_agents2) — Swimmer CPU + checkpoints + logger")
    print("=" * 70)
