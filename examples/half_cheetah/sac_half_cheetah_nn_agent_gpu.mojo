...
GPU successor of `sac_half_cheetah_nn_agent.mojo` (the CPU nn example) and
...
Run:
    pixi run -e apple  mojo run -I . examples/half_cheetah/sac_half_cheetah_nn_agent_gpu.mojo  # Apple Silicon
    pixi run -e nvidia mojo run -I . examples/half_cheetah/sac_half_cheetah_nn_agent_gpu.mojo  # NVIDIA GPU
"""
