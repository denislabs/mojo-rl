...
Run with:
    pixi run -e apple mojo run -I . tests/test_ppo_half_cheetah_continuous_eval_gpu.mojo
    pixi run -e nvidia mojo run -I . tests/test_ppo_half_cheetah_continuous_eval_gpu.mojo
"""
