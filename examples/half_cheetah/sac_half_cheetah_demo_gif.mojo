"""Train SAC on HalfCheetah (CPU), then record a GIF of the trained agent.

Run with:
    pixi run -e apple mojo run -I . examples/half_cheetah/sac_half_cheetah_demo_gif.mojo
"""
...
def main() raises:
    ...
    # ==========================================================================
    print("=" * 60)
    print("  HalfCheetah SAC — Train + GIF Export")
    print("=" * 60)
    print()
    ...
    env.start_recording("gifs/half_cheetah_sac_trained.gif", fps=30, skip=3)
    ...
    print()
    print("Saved: gifs/half_cheetah_sac_trained.gif")
    print("Done!")
