"""SAC HalfCheetah (deep_agents2 / nn2 agent) — short run for nsys profiling.

nn2 counterpart of `sac_half_cheetah_profile_graph.mojo` (which profiles the
...
apples — the only difference is the agent stack (deep_agents2 `SACAgent` facade
...
Run with:
    pixi run -e nvidia nsys profile --stats=true mojo run -I . \
        examples/half_cheetah/sac_half_cheetah_profile_graph_nn2.mojo
...
def main() raises:
    seed(42)
    print("=== SAC HalfCheetah nsys profile (deep_agents2 / nn2) ===")
