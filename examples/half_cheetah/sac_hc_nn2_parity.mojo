"""SAC CPU-vs-GPU target-parity control (HalfCheetah, deep_agents2).

Companion control for `mbpo_hc_nn2_parity.mojo`. That harness showed the
...
Run:
    pixi run -e apple  mojo run -I . examples/half_cheetah/sac_hc_nn2_parity.mojo
    pixi run -e nvidia mojo run -I . examples/half_cheetah/sac_hc_nn2_parity.mojo
