...
Sibling of `sac_half_cheetah_nn_agent.mojo` and
`ddpg_half_cheetah_nn_agent.mojo`. TD3 adds three tricks on top of
DDPG:
...
Run:
    pixi run mojo run -I . examples/half_cheetah/td3_half_cheetah_nn_agent.mojo
"""
