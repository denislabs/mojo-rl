...
struct HalfCheetah[
    ...
    fn init_renderer(mut self) raises -> Bool:
        ...
        var renderer = HalfCheetahRenderer(
            ...
            cam_eye_y=HalfCheetahCamera.POS_Y,
            cam_eye_z=HalfCheetahCamera.POS_Z,
            cam_target_z=HalfCheetahCamera.TARGET_Z,
            axes_offset=1.5,
            vel_arrow_height=0.15,
            vel_arrow_scale=0.1,
            light_dir_x=HalfCheetahLight.DIR_X,
            light_dir_y=HalfCheetahLight.DIR_Y,
            light_dir_z=HalfCheetahLight.DIR_Z,
            light_color_r=HalfCheetahLight.COLOR_R,
            light_color_g=HalfCheetahLight.COLOR_G,
            light_color_b=HalfCheetahLight.COLOR_B,
            light_ambient=HalfCheetahLight.AMBIENT,
        )
        renderer.init()
