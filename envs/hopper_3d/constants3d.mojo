...
Based on MuJoCo Hopper with physics3d_v2 engine.
Supports both CPU (Float64) and GPU (Float32) execution.
"""

from physics3d_v2 import Model, Data
...
struct Hopper3DConstants[DTYPE: DType = DType.float64]:
    ...
    # ==========================================================================
    # GPU Layout Constants (using physics3d_v2 layout)
    # ==========================================================================

    # Compute state size for GPU buffer using physics3d_v2's layout formula
