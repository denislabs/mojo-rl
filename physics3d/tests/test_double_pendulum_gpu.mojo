...
fn main() raises:
    ...
    state_host[j0_off + JOINT_IDX_ANCHOR_PX] = Scalar[DTYPE](
        0
    )  # Pivot at (0, 0, pivot_z)
    state_host[j0_off + JOINT_IDX_ANCHOR_PY] = Scalar[DTYPE](0)
    state_host[j0_off + JOINT_IDX_ANCHOR_PZ] = Scalar[DTYPE](pivot_z)
    state_host[j0_off + JOINT_IDX_ANCHOR_CX] = Scalar[DTYPE](
        0
    )  # L1 above body 0
    ...
    state_host[j1_off + JOINT_IDX_ANCHOR_PX] = Scalar[DTYPE](
        0
    )  # At body 0's position
    state_host[j1_off + JOINT_IDX_ANCHOR_PY] = Scalar[DTYPE](0)
    state_host[j1_off + JOINT_IDX_ANCHOR_PZ] = Scalar[DTYPE](0)
    state_host[j1_off + JOINT_IDX_ANCHOR_CX] = Scalar[DTYPE](
        0
    )  # L2 above body 1
