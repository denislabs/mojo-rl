...
fn test_box_box_face_face() -> Bool:
    ...
    model.set_body_box(
        0, mass=1000.0, half_x=big_hx, half_y=big_hy, half_z=big_hz
    )
    ...
    model.set_body_box(
        1, mass=1.0, half_x=small_hx, half_y=small_hy, half_z=small_hz
    )
...
fn test_stacked_boxes_stability() -> Bool:
    ...
    for i in range(NUM_BODIES):
        model.set_body_box(
            i, mass=1.0, half_x=half_ext, half_y=half_ext, half_z=half_ext
        )
