...
fn main() raises:
    ...
    print("GPU ready  WS_SIZE =", WS_SIZE)
    print()
    ...
    # --- No contact, nonzero velocity (qDeriv != 0 — tests RNE derivative) ---
    var vel_nonzero = InlineArray[Float64, NV](fill=0.0)
    vel_nonzero[0] = 1.0  # root x
    vel_nonzero[2] = 0.5  # root y
