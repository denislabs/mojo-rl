...
Run with:
    cd mojo-rl && pixi run mojo run physics3d/tests/test_primal_cg_vs_mujoco.mojo
"""
...
# Tolerances (same as Newton test)
...
fn compare_solver_forces(
    ...
    """Run full pipeline + CG solver in both engines, compare forces and qacc."""
    ...
    # Set solref/solimp from HalfCheetahParams
...
# =============================================================================
# Test cases (same 4 configs as Newton test)
# =============================================================================
...
fn main() raises:
    print("=" * 60)
    print("Primal CG Solver Forces: Mojo Engine vs MuJoCo")
    print("=" * 60)
