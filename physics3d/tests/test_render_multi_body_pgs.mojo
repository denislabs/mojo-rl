...
Run with:
    pixi run mojo run physics3d/tests/test_render_multi_body_v2.mojo

Time limit: Set MAX_DURATION_SECONDS to limit demo duration (0 = infinite).
"""

from physics3d.types import Model, Data
from physics3d.integrator import PGSIntegrator
...
fn main() raises:
    ...
    while not renderer.check_quit():
        ...
        # Run multiple physics steps per frame using PGS solver
