...
# ---------------------------------------------------------------------------
fn test_unconstrained_dofs() -> Bool:
...
# ---------------------------------------------------------------------------
fn main():
    print("=== Solver Island Detection Tests ===\n")

    var all_pass = True

    if not test_no_constraints():
        all_pass = False
    if not test_single_island():
        all_pass = False
    if not test_two_islands():
        all_pass = False
    if not test_three_islands():
        all_pass = False
    if not test_chain_merges():
        all_pass = False
    if not test_unconstrained_dofs():
        all_pass = False
    if not test_negative_j():
        all_pass = False
