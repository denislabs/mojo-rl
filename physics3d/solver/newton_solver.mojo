...
struct NewtonSolver(ConstraintSolver):
    ...
    fn solver_workspace_size[NV: Int, MAX_CONTACTS: Int]() -> Int:
        """Newton solver workspace: 49*MC + 12*MC*NV + MC*MC floats.
        ...
        Layout (offsets relative to solver workspace start):
          ...
          [18*MC+2*MC*NV+MC*MC..49*MC+12*MC*NV+MC*MC)   Friction (31*MC + 10*MC*NV)
        """
        comptime MC = _max_one[MAX_CONTACTS]()
        return 49 * MC + 12 * MC * NV + MC * MC
