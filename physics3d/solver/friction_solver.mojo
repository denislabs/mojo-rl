            ...
            if CONE_TYPE == ConeType.PYRAMIDAL:
                ...
                if num_fric == 2:
                    ...
                    var f4 = rebind[Scalar[DTYPE]](
                        workspace[env, lf + 3 * MC + c]
                    )
                    var f5 = rebind[Scalar[DTYPE]](
                        workspace[env, lf + 4 * MC + c]
                    )
                    qcqp5[DTYPE](
                        f1,
                        f2,
