# Procgen Asset Licenses & Attribution
...
environment. This file reproduces the upstream attribution list to satisfy those
terms. The remaining packs are CC0 (public domain, no attribution required).

The list below is reproduced verbatim from the upstream `ASSET_LICENSES.md`.
