"""CPU evaluation with 3D rendering for continuous PPO on HopperGC.
...
Run with:
    pixi run mojo run tests/test_ppo_hopper_gc_continuous_eval_cpu.mojo
"""
...
comptime MAX_STEPS = 1000  # HopperGC episodes run for max 1000 steps
