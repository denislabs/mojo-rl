"""Regression gate (GOLDEN-frozen): full Euler step WITH CONTACTS on the fields
path, Walker2D on the floor.

Originally validated BIT-EXACT against the legacy Euler+PGS contact pipeline.
