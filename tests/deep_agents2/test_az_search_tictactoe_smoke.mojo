"""End-to-end smoke: nn2 AlphaZero prediction net + true-game-rules MCTS on the
...
search loop reusing ``GenericGPUMCTS`` verbatim, with the only nn2-new pieces
...
Run (Apple Metal):
    pixi run -e apple mojo run -I . tests/deep_agents2/test_az_search_tictactoe_smoke.mojo
"""
