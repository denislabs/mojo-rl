"""End-to-end smoke: nn2 MuZero h/g/f nets + learned-dynamics GPU MCTS via the
...
nn2-new pieces being the three adapters (`MZRepGPU` / `MZDynGPU` / `MZPredGPU`).
...
Run (Apple Metal):
    pixi run -e apple mojo run -I . tests/deep_agents2/test_mz_search_smoke.mojo
"""
