...
Run:
    pixi run -e apple mojo run -I . tests/deep_agents2/test_ezv2_atari_targets.mojo
"""
...
from mojo_rl.deep_agents2.zero.nstep_targets import compute_nstep_value_targets
