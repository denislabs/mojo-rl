...
Run (GPU env required):
    pixi run -e apple mojo run -I . tests/deep_agents2/test_ezv2_per_train_step.mojo
"""
...
from mojo_rl.deep_agents2.efficient_zero_v2.unroll_scratch import EZV2UnrollScratch
