...
def main() raises:
    print("=" * 78)
    print("PC per-level error profile — 8-level P6 stack")
    print("=" * 78)
    print("  levels (l = 0 bottom .. ", NET.N - 1, " readout):")
    print("    0 conv3->32   1 norm   2 conv32->64   3 norm")
    print("    4 conv64->64  5 norm   6 fc1024->256  7 readout256->10")
