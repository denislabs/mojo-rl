...
trains end-to-end on GPU using the existing pcn GPU primitives:
...
Run:
    pixi run -e apple  mojo run -I . tests/pcn/test_pc_dynamics_gpu_smoke.mojo
    pixi run -e nvidia mojo run -I . tests/pcn/test_pc_dynamics_gpu_smoke.mojo
"""
...
from mojo_rl.experimental.pcn import PCDynamics
