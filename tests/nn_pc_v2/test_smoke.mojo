"""Smoke test for nn_pc_v2 — small fixed-seed PCN end-to-end on synthetic data.
...
Run:
    pixi run mojo run -I . tests/nn_pc_v2/test_smoke.mojo
"""
...
def main() raises:
    print("=== nn_pc_v2 smoke test (Bogacz canonical) ===")
    print("  N           =", NET.N)
