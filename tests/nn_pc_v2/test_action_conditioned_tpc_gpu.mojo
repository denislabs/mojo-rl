...
Run:
    pixi run -e apple  mojo run -I . tests/nn_pc_v2/test_action_conditioned_tpc_gpu.mojo
    pixi run -e nvidia mojo run -I . tests/nn_pc_v2/test_action_conditioned_tpc_gpu.mojo
"""
