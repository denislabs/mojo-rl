...
Run:
    pixi run mojo run -I . tests/nn_pc_v2/test_mountain_car_cem_planning_swish.mojo
"""
...
def main() raises:
    print("=" * 60)
    print("MountainCar Continuous — CEM planning demo (PCN world model, swish+identity)")
    print("=" * 60)
