"""CPU vs GPU MCPC parity test for nn_pc_v2.
...
Run:
    pixi run -e apple  mojo run -I . tests/nn_pc_v2/test_mcpc_cpu_vs_gpu.mojo
    pixi run -e nvidia mojo run -I . tests/nn_pc_v2/test_mcpc_cpu_vs_gpu.mojo
"""
...
def main() raises:
    print("=" * 60)
    print("nn_pc_v2 MCPC CPU vs GPU parity test")
    print("=" * 60)
    print("  arch       : 6 → 8 → 5 → 3")
