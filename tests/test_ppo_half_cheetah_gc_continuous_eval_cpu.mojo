"""CPU evaluation with 3D rendering for continuous PPO on HalfCheetahGC.
...
The HalfCheetahGC environment uses the Generalized Coordinates (GC) physics
engine which provides MuJoCo-style joint-space dynamics.

Run with:
    pixi run mojo run tests/test_ppo_half_cheetah_gc_continuous_eval_cpu.mojo
"""
...
comptime MAX_STEPS = 1000  # HalfCheetahGC episodes run for 1000 steps
...
fn main() raises:
    ...
    print("HalfCheetahGC (Generalized Coordinates Physics)")
    print("=" * 70)
    print()
    ...
    print()
    print("-" * 70)
    print("CPU EVALUATION SUMMARY - HalfCheetahGC")
    print("-" * 70)
    print("Episodes:", NUM_EPISODES)
