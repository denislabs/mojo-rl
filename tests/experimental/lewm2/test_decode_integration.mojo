...
Mirrors `examples/lewm/lewm2_pusht_decode_gpu.mojo` at toy scale to validate
...
Run:  pixi run -e apple mojo run -I . tests/experimental/lewm2/test_decode_integration.mojo
"""
...
def main() raises:
    ...
    save_reconstruction_grid(
        String("/tmp/lewm2_decode_integration.ppm"),
        pix_h.unsafe_ptr(),
