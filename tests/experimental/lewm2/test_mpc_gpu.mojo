...
toy dims so it runs cheaply on Apple. Asserts the pipeline runs + scores
finite.

Run:  pixi run -e apple mojo run -I . tests/experimental/lewm2/test_mpc_gpu.mojo
"""
