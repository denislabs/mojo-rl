"""lewm2_shuffled_eval test (CPU, toy) — continuous-action-compatible.
...
Run:  pixi run mojo run -I . tests/experimental/lewm2/test_shuffled_eval.mojo
"""
...
def main() raises:
    print("=" * 70)
    print("lewm2_shuffled_eval (CPU, toy)")
    print("=" * 70)
