"""Debug script to track train-eval gap growth over time for HalfCheetah3D.
...
Run with:
    pixi run -e apple mojo run tests/debug_ppo_half_cheetah_3d_gap_growth.mojo
    pixi run -e nvidia mojo run tests/debug_ppo_half_cheetah_3d_gap_growth.mojo
"""
...
# =============================================================================
# Constants (matching test_ppo_half_cheetah_3d_continuous_gpu.mojo)
# =============================================================================
...
fn main() raises:
    seed(42)
    print("=" * 70)
    print("DEBUG: Tracking Train-Eval Gap Growth Over Time (HalfCheetah3D)")
    print("=" * 70)
    print()
    print("Configuration:")
    ...
    with DeviceContext() as ctx:
        ...
        while episodes_trained < TOTAL_EPISODES:
            ...
            var metrics = agent.train_gpu[HalfCheetah3D[gpu_dtype]](
                ctx,
        ...
        print()
        print("=" * 130)
        print("GAP GROWTH ANALYSIS (HalfCheetah3D)")
        print("=" * 130)
        print()
    ...
    print(">>> Gap growth analysis completed (HalfCheetah3D) <<<")
