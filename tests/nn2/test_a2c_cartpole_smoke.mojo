...
Run:
    pixi run mojo run -I . tests/nn2/test_a2c_cartpole_smoke.mojo
"""
...
from mojo_rl.deep_agents2.a2c import A2CDiscreteAgent
...
def main() raises:
    seed(42)
    print("=" * 64)
    print("nn2 A2C (A2CDiscreteAgent = single-epoch PPO) — CartPole (CPU)")
    print("=" * 64)
