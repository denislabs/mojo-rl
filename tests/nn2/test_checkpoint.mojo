...
from mojo_rl.nn2.core.checkpoint import save_params, load_params
...
def test_linear_roundtrip() raises:
    ...
    var path = String("/tmp/test_nn2_ckpt_linear.txt")
    comptime BATCH = 2
    comptime IN = 3
    comptime OUT = 2
...
def test_sequential_roundtrip_after_training() raises:
    ...
    var path = String("/tmp/test_nn2_ckpt_sequential.txt")
    comptime BATCH = 4
    comptime IN = 4
    comptime HID = 8
    comptime OUT = 2
