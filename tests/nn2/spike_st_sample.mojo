...
Run: `pixi run mojo run -I . tests/nn2/spike_st_sample.mojo`
"""
...
from mojo_rl.deep_agents2.dreamerv3.rssm_ops import StraightThroughSample

comptime FIX = "tests/nn2/dreamerv3/fixtures/st_fixture.txt"
comptime B = 2
comptime STOCH = 3
comptime CLASSES = 5
