"""TaskEmbedder — embed correctness, grad overfit, CPU↔GPU parity (Phase 3.4).
    ...
    pixi run            mojo run -I . tests/nn2/test_dreamer4_task_embedder.mojo  # CPU
    pixi run -e apple   mojo run -I . tests/nn2/test_dreamer4_task_embedder.mojo  # +GPU
...
from mojo_rl.deep_agents2.dreamer4.task_embedder import TaskEmbedder
