...
Goal: decide whether the nn2 composition infra is clean + correct enough to
...
Run: `pixi run mojo run -I . tests/nn2/spike_rssm_core_graph.mojo`
"""
...
from mojo_rl.nn2.core.amp import NoAMP
...
comptime FIX4 = "tests/nn2/dreamerv3/fixtures/pr4_fixture.txt"
comptime FIX5 = "tests/nn2/dreamerv3/fixtures/pr5b2_fixture.txt"
comptime B = 2
comptime DETER = 16
comptime H = 12
comptime STOCH = 3
