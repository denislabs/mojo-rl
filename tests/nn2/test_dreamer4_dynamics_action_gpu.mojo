"""Dreamer4Dynamics action conditioning — CPU↔GPU parity.
    ...
    pixi run -e apple  mojo run -I . tests/nn2/test_dreamer4_dynamics_action_gpu.mojo
    pixi run -e nvidia mojo run -I . tests/nn2/test_dreamer4_dynamics_action_gpu.mojo
