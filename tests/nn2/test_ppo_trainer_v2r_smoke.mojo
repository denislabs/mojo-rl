"""PPOTrainerV2R smoke — construction + a single rollout-update cycle.

P.1 gate: V2R trainer compiles, constructs, runs ROLLOUT_LEN env steps,
and the update fires exactly once at the boundary. Same shape as
test_ppo_trainer_smoke.mojo but for the new V2R trainer.
...
def main() raises:
    print("=" * 70)
    print("PPOTrainerV2R smoke (P.1 — CPU N_ENVS=1)")
    print("=" * 70)
    test_construction()
