...
Design (after probing what Float64 conforms to):
  ...
  how the rest of nn2 handles `Scalar[DT]`. Bundle author writes
  `var critic_loss: LogScalar[DT]` (DT comes from nn2.constants).
"""
...
# Compile-time gated to floating-point DT, matches the rest of nn2.
# ---------------------------------------------------------------------
@fieldwise_init
