...
Probe C: can Variant wrap distinct LayoutTensor types?
    ...
    — but at the cost of mixing two tensor abstractions in nn2.
"""
...
def probe_c_layouttensor_variant() raises:
    ...
    if ok:
        ...
        print("           BUT LayoutTensor != TileTensor — using this in nn2")
...
def main() raises:
    ...
    print("  Same blocker DR.3 hit on `out_view()`. nn2 always uses generic")
