...
nn2 `Conv2D` / `Flatten` expose FLAT `IN_DIMS` / `OUT_DIM` (the spatial
...
Run:
    pixi run mojo run -I . tests/nn2/test_ppo_discrete_cnn_smoke.mojo
"""
...
from mojo_rl.deep_agents2.ppo_discrete.trainer import PPODiscreteTrainer
