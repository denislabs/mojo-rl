...
part 2. Run: `pixi run mojo run -I . tests/nn2/test_dreamer_pr5b.mojo`
"""
...
from mojo_rl.deep_agents2.dreamerv3.imag_loss import imag_loss_backward
from mojo_rl.deep_agents2.dreamerv3.repl_loss import repl_loss_backward


comptime FIXTURE = "tests/nn2/dreamerv3/fixtures/pr5b_fixture.txt"
comptime BK = 2
comptime T = 4
comptime ACT = 1
comptime BINS = 41
