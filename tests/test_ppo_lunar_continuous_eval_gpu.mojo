...
fn main() raises:
    ...
    with DeviceContext() as ctx:
        ...
        print("LunarLander expected rewards:")
        print("  Random policy: ~-200 to -400")
        print("  Good policy: > 0")
        print("  Solved: > 200")
        print()

        if stochastic_reward > 200:
            print("EXCELLENT: Agent solved LunarLander!")
        elif stochastic_reward > 100:
            print("VERY GOOD: Consistent successful landings!")
        elif stochastic_reward > 0:
            print("GOOD: Positive average reward!")
        elif stochastic_reward > -100:
