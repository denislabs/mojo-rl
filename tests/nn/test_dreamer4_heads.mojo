"""Dreamer 4 MTP policy + reward heads — overfit via dist losses (Phase 3.5).
    ...
    pixi run mojo run -I . tests/nn/test_dreamer4_heads.mojo

The heads are plain nn Sequential MLPs producing NMTP distance-major logit
...
from mojo_rl.deep_agents.dreamerv3.dists_discrete import cat_fwd, cat_bwd, cat_argmax
