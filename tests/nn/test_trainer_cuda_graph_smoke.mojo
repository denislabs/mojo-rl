"""Smoke test: the nn Trainer's CUDA-graph-capturable device step.
...
Run (Apple):  pixi run -e apple  mojo run -I . tests/nn/test_trainer_cuda_graph_smoke.mojo
Run (NVIDIA): pixi run -e nvidia mojo run -I . tests/nn/test_trainer_cuda_graph_smoke.mojo
"""
