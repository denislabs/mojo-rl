...
1024 inner > emb 192). This test exercises that path on nn via the new
...
Run:  pixi run -e apple mojo run -I . tests/nn/test_conditional_block_xl.mojo
"""
...
from mojo_rl.nn.combinators import RepeatConditional
