...
nn `Conv2D`/`Flatten` expose FLAT `IN_DIMS`/`OUT_DIM` (the spatial shape
...
Run:
    pixi run mojo run -I . tests/nn/test_dqn_cnn_config_smoke.mojo
    pixi run -e apple mojo run -I . tests/nn/test_dqn_cnn_config_smoke.mojo
"""
