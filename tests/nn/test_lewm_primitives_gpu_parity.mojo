"""CPU↔GPU parity for the LeWM nn primitives (Phase A).
...
Run with the GPU env, e.g.:
    pixi run -e apple mojo run -I . tests/nn/test_lewm_primitives_gpu_parity.mojo
"""
...
from mojo_rl.nn.primitives.gate import Gate
...
def main() raises:
    print("=" * 70)
    print("LeWM nn primitives — CPU/GPU parity (Phase A)")
    print("=" * 70)
