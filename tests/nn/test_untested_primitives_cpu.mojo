"""Unit coverage for three previously-untested nn primitives (audit L6).
...
Run: `pixi run mojo run -I . tests/nn/test_untested_primitives_cpu.mojo`
"""
...
from mojo_rl.nn.combinators.branch_concat import BranchConcat
...
def main() raises:
    print("=" * 70)
    print("nn untested-primitive coverage (L6)")
    print("=" * 70)
    test_zero_linear()
    test_mse_per_sample()
    test_branch_concat()
