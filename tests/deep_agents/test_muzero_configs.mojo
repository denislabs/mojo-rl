...
def main():
    ...
    print(
        "ResNet: Rep PARAMS:",
        C3.RepModel.PARAM_SIZE,
        "| Dyn PARAMS:",
        C3.DynModel.PARAM_SIZE,
    )
    ...
    print(
        "AlphaZero: Search.USE_LEARNED_DYNAMICS:",
        C5.Search.USE_LEARNED_DYNAMICS,
        "| Search.NEEDS_GAME_STATE:",
        C5.Search.NEEDS_GAME_STATE,
        "| Encoding.IS_DISTRIBUTIONAL:",
        C5.Encoding.IS_DISTRIBUTIONAL,
        "| PUCT.C_INIT:",
        C5.PUCT.C_INIT,
        "| Backup.BACKUP_TYPE:",
        C5.Backup.BACKUP_TYPE,
        "| Players.IS_SELF_PLAY:",
        C5.Players.IS_SELF_PLAY,
    )

    # EfficientZero Config
    comptime C6 = EfficientZeroConfig[4, 2]
    print(
        "EfficientZero: Backup.LAMBDA:",
        C6.Backup.LAMBDA,
        "| USE_REANALYZE:",
        C6.USE_REANALYZE,
    )
