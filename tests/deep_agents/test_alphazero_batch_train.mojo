...
def main() raises:
    ...
    for iter in range(20):
        ...
        comptime _DIAG_BATCH = TTTBatchConfig.batch_size
        comptime _DIAG_POUT = TTTBatchConfig.PredModel.OUT_DIM
        comptime _DIAG_PS = TTTBatchConfig.PredModel.PARAM_SIZE
