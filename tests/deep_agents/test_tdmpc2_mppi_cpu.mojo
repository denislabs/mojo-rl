"""TD-MPC2 MPPI (CPU) integration — nn world model ↔ shared MPPICPU planner.
...
callback bridge (List[Float64] ↔ nn forward, two-hot reward/Q decode,
...
from mojo_rl.deep_agents.tdmpc2.callback import TDMPC2RolloutCallbackCPU
