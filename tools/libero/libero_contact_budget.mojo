...
batched `max_contacts`.
    ...
    pixi run mojo run -I . tools/libero/libero_contact_budget.mojo            # all 23
    pixi run mojo run -I . tools/libero/libero_contact_budget.mojo libero_object
...
Writes `noeira/envs/libero/tables/contact_budget.kv`: `<family>=<max>,<task>`.
"""
...
comptime OUT_PATH = "noeira/envs/libero/tables/contact_budget.kv"
comptime CAP = 512
...
def main() raises:
    ...
    if only != "":
        ...
        return
    var text = String(
        "# GENERATED by tools/libero/libero_contact_budget.mojo — do not edit.\n"
