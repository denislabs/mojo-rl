...
MODELS = [
    ...
    ("mojo_rl/tasks/libero_envs/libero_kitchen_scene1_xml.mojo", ["LIBERO_KITCHEN_SCENE1_XML"]),
    ("mojo_rl/tasks/libero_envs/libero_kitchen_scene10_xml.mojo", ["LIBERO_KITCHEN_SCENE10_XML"]),
    ("mojo_rl/tasks/libero_envs/libero_kitchen_scene2_xml.mojo", ["LIBERO_KITCHEN_SCENE2_XML"]),
    ("mojo_rl/tasks/libero_envs/libero_kitchen_scene3_xml.mojo", ["LIBERO_KITCHEN_SCENE3_XML"]),
    ("mojo_rl/tasks/libero_envs/libero_kitchen_scene4_xml.mojo", ["LIBERO_KITCHEN_SCENE4_XML"]),
    ("mojo_rl/tasks/libero_envs/libero_kitchen_scene5_xml.mojo", ["LIBERO_KITCHEN_SCENE5_XML"]),
    ("mojo_rl/tasks/libero_envs/libero_kitchen_scene6_xml.mojo", ["LIBERO_KITCHEN_SCENE6_XML"]),
    ("mojo_rl/tasks/libero_envs/libero_kitchen_scene7_xml.mojo", ["LIBERO_KITCHEN_SCENE7_XML"]),
    ("mojo_rl/tasks/libero_envs/libero_kitchen_scene8_xml.mojo", ["LIBERO_KITCHEN_SCENE8_XML"]),
    ("mojo_rl/tasks/libero_envs/libero_kitchen_scene9_xml.mojo", ["LIBERO_KITCHEN_SCENE9_XML"]),
    ("mojo_rl/tasks/libero_envs/libero_living_room_scene1_xml.mojo", ["LIBERO_LIVING_ROOM_SCENE1_XML"]),
    ("mojo_rl/tasks/libero_envs/libero_living_room_scene2_xml.mojo", ["LIBERO_LIVING_ROOM_SCENE2_XML"]),
    ("mojo_rl/tasks/libero_envs/libero_living_room_scene3_xml.mojo", ["LIBERO_LIVING_ROOM_SCENE3_XML"]),
    ("mojo_rl/tasks/libero_envs/libero_living_room_scene4_xml.mojo", ["LIBERO_LIVING_ROOM_SCENE4_XML"]),
    ("mojo_rl/tasks/libero_envs/libero_living_room_scene5_xml.mojo", ["LIBERO_LIVING_ROOM_SCENE5_XML"]),
    ("mojo_rl/tasks/libero_envs/libero_living_room_scene6_xml.mojo", ["LIBERO_LIVING_ROOM_SCENE6_XML"]),
    ("mojo_rl/tasks/libero_envs/libero_study_scene1_xml.mojo", ["LIBERO_STUDY_SCENE1_XML"]),
    ("mojo_rl/tasks/libero_envs/libero_study_scene2_xml.mojo", ["LIBERO_STUDY_SCENE2_XML"]),
    ("mojo_rl/tasks/libero_envs/libero_study_scene3_xml.mojo", ["LIBERO_STUDY_SCENE3_XML"]),
    ("mojo_rl/tasks/libero_envs/libero_study_scene4_xml.mojo", ["LIBERO_STUDY_SCENE4_XML"]),
...
def asset_path(module: str, sym: str) -> str:
    ...
    if parts[1] == "tasks":
        return "mojo_rl/tasks/scenes/%s.xml" % base
