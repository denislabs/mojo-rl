...
MODELS = [
    ...
    ("noeira/tasks/libero_goal_xml.mojo", ["LIBERO_GOAL_XML"]),
    ("noeira/tasks/libero_spatial_xml.mojo", ["LIBERO_SPATIAL_XML"]),
    ("noeira/tasks/libero_object_xml.mojo", ["LIBERO_OBJECT_XML"]),
    # ⚠ THE TWENTY LIBERO-10/90 SCENE FAMILIES — model defs GENERATED by
    # `tools/tasks/gen_libero_envs.mojo` into `tasks/libero_envs/`.
    ("noeira/tasks/libero_envs/libero_kitchen_scene1_xml.mojo", ["LIBERO_KITCHEN_SCENE1_XML"]),
    ("noeira/tasks/libero_envs/libero_kitchen_scene10_xml.mojo", ["LIBERO_KITCHEN_SCENE10_XML"]),
    ("noeira/tasks/libero_envs/libero_kitchen_scene2_xml.mojo", ["LIBERO_KITCHEN_SCENE2_XML"]),
    ("noeira/tasks/libero_envs/libero_kitchen_scene3_xml.mojo", ["LIBERO_KITCHEN_SCENE3_XML"]),
    ("noeira/tasks/libero_envs/libero_kitchen_scene4_xml.mojo", ["LIBERO_KITCHEN_SCENE4_XML"]),
    ("noeira/tasks/libero_envs/libero_kitchen_scene5_xml.mojo", ["LIBERO_KITCHEN_SCENE5_XML"]),
    ("noeira/tasks/libero_envs/libero_kitchen_scene6_xml.mojo", ["LIBERO_KITCHEN_SCENE6_XML"]),
    ("noeira/tasks/libero_envs/libero_kitchen_scene7_xml.mojo", ["LIBERO_KITCHEN_SCENE7_XML"]),
    ("noeira/tasks/libero_envs/libero_kitchen_scene8_xml.mojo", ["LIBERO_KITCHEN_SCENE8_XML"]),
    ("noeira/tasks/libero_envs/libero_kitchen_scene9_xml.mojo", ["LIBERO_KITCHEN_SCENE9_XML"]),
    ("noeira/tasks/libero_envs/libero_living_room_scene1_xml.mojo", ["LIBERO_LIVING_ROOM_SCENE1_XML"]),
    ("noeira/tasks/libero_envs/libero_living_room_scene2_xml.mojo", ["LIBERO_LIVING_ROOM_SCENE2_XML"]),
    ("noeira/tasks/libero_envs/libero_living_room_scene3_xml.mojo", ["LIBERO_LIVING_ROOM_SCENE3_XML"]),
    ("noeira/tasks/libero_envs/libero_living_room_scene4_xml.mojo", ["LIBERO_LIVING_ROOM_SCENE4_XML"]),
    ("noeira/tasks/libero_envs/libero_living_room_scene5_xml.mojo", ["LIBERO_LIVING_ROOM_SCENE5_XML"]),
    ("noeira/tasks/libero_envs/libero_living_room_scene6_xml.mojo", ["LIBERO_LIVING_ROOM_SCENE6_XML"]),
    ("noeira/tasks/libero_envs/libero_study_scene1_xml.mojo", ["LIBERO_STUDY_SCENE1_XML"]),
    ("noeira/tasks/libero_envs/libero_study_scene2_xml.mojo", ["LIBERO_STUDY_SCENE2_XML"]),
    ("noeira/tasks/libero_envs/libero_study_scene3_xml.mojo", ["LIBERO_STUDY_SCENE3_XML"]),
    ("noeira/tasks/libero_envs/libero_study_scene4_xml.mojo", ["LIBERO_STUDY_SCENE4_XML"]),
