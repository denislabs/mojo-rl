...
counted and named. As of L2 that is 1 of 10 for `libero_goal` — L3 is what
raises it — and the count is printed so the number cannot drift unnoticed.
"""
...
from mojo_rl.tasks.spec import FamilySpec, TaskSpec, validate_task_against_family
