...
from physics3d_v2.gpu.constants import GEOM_SPHERE, GEOM_CAPSULE
...
fn test_sphere_on_horizontal_capsule() -> Bool:
    ...
    model.set_body_capsule(0, mass=10.0, radius=cap_radius, half_length=cap_half_len)
...
fn test_sphere_slides_along_capsule() -> Bool:
    ...
    model.set_body_capsule(0, mass=100.0, radius=cap_radius, half_length=cap_half_len)
