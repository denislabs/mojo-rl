...
from physics3d_v2.envs import WalkerEnv
...
fn test_initialization() raises:
    ...
    assert_true(
        env.model.masses[0] > 0 and env.model.masses[1] > 0 and env.model.masses[2] > 0,
...
fn test_torque_causes_motion() raises:
    ...
    assert_true(
        ...
        "At least one hip angle should change significantly with asymmetric torque",
    )
