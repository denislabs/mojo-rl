...
fn test_sphere_box_face() -> Bool:
    ...
    model.set_body_box(0, mass=1000.0, half_x=half_x, half_y=half_y, half_z=half_z)
...
fn test_sphere_box_edge() -> Bool:
    ...
    model.set_body_box(0, mass=1000.0, half_x=half_ext, half_y=half_ext, half_z=half_ext)
    ...
    data.set_body_position(1, half_ext + sphere_radius * Scalar[DTYPE](0.5), 0.0, 1.0)
