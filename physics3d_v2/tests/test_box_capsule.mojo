...
fn test_capsule_box_face() -> Bool:
    ...
    model.set_body_box(0, mass=1000.0, half_x=box_hx, half_y=box_hy, half_z=box_hz)

    # Body 1: Capsule (falling)
    var cap_radius: Scalar[DTYPE] = 0.05
    var cap_half_len: Scalar[DTYPE] = 0.1
    model.set_body_capsule(1, mass=1.0, radius=cap_radius, half_length=cap_half_len)
