...
extracts it to nn/random/. Phase 7 used `std.random.random_float64`
...
element. Pattern lifted from `noeira/experimental/pcn/pc_trainer.mojo`
to keep API identical between v1 and nn callers.
"""
