...
"""The `TorchNameMap` for `models/resnet18.mojo`, in both directions.
    ...
    from noeira.nn.models.resnet18_torch import resnet18_torch_map
    from noeira.nn.core.torch_names import LoadTorchNamed
...
from noeira.nn.core.torch_names import TorchNameMap, TN_PLAIN, TN_ZEROS
