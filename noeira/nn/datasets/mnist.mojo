...
to ~/.cache/noeira/mnist/*.ubyte. Subsequent runs read the cached
...
from noeira.io.http import gunzip, http_get_bytes
...
def _cache_dir() raises -> String:
    """Resolve ~/.cache/noeira/mnist and ensure it exists."""
    var path = noeira_cache() + "/mnist"
