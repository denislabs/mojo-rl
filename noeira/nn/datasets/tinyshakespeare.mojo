...
into ~/.cache/noeira/tinyshakespeare/input.txt and parses it natively in Mojo.
...
from noeira.io.http import http_get_bytes
...
def _cache_dir() raises -> String:
    var path = noeira_cache() + "/tinyshakespeare"
