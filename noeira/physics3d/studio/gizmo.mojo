...
WHY THIS IS A SEPARATE FILE. `noeira/render/imgui`'s `gz_*` bindings draw a
...
from noeira.math3d import Vec3 as Vec3G, Quat as QuatG, Mat3 as Mat3G
from noeira.math3d import Mat4 as Mat4G
