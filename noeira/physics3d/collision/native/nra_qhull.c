/* nra_qhull.c — the convex-hull FACE LIST, in qhull's order.
 *
 ...
 */
int nra_qhull_faces(const double* verts, int nvert, int maxhullvert,
...
int nra_qhull_maxfaces(int nvert) {
