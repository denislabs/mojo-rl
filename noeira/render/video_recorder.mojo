...
taken the viewer down with it — measured, exit 141 = 128+13. `noeira/io/proc`
...
from noeira.io.proc import WritePipe, quote_arg
from noeira.io.video.frame_pipe_thread import FramePipeThread
