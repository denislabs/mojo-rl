...
`https://` URLs can need `HF_TOKEN`, `NOEIRA_CLOUD_API_KEY`, or nothing at all.
...
| `noeira`   | `id=`   | `NOEIRA_CLOUD_API_KEY`        | catalog call -> **presigned** URL -> unauthenticated GET |
