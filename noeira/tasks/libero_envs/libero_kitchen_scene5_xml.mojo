...
from noeira.tasks.libero_envs.budgets import LIBERO_KITCHEN_SCENE5_MAX_CONTACTS
from noeira.tasks.libero_envs.libero_kitchen_scene5_dims import LIBERO_KITCHEN_SCENE5_DIMS
...
comptime LiberoKitchenScene5Model = ModelDefFromXML[
    xml_path="noeira/tasks/scenes/libero_kitchen_scene5.xml",
    nbody=_pm.NBODY,
    njoint=_pm.NJOINT,
    nq=_pm.NQ,
    nv=_pm.NV,
