...
from noeira.tasks.libero_envs.budgets import LIBERO_KITCHEN_SCENE9_MAX_CONTACTS
from noeira.tasks.libero_envs.libero_kitchen_scene9_dims import LIBERO_KITCHEN_SCENE9_DIMS
...
comptime LiberoKitchenScene9Model = ModelDefFromXML[
    xml_path="noeira/tasks/scenes/libero_kitchen_scene9.xml",
    nbody=_pm.NBODY,
    njoint=_pm.NJOINT,
    nq=_pm.NQ,
    nv=_pm.NV,
