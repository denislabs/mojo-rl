...
from noeira.tasks.libero_envs.budgets import LIBERO_STUDY_SCENE2_MAX_CONTACTS
from noeira.tasks.libero_envs.libero_study_scene2_dims import LIBERO_STUDY_SCENE2_DIMS
...
comptime LiberoStudyScene2Model = ModelDefFromXML[
    xml_path="noeira/tasks/scenes/libero_study_scene2.xml",
    nbody=_pm.NBODY,
    njoint=_pm.NJOINT,
    nq=_pm.NQ,
    nv=_pm.NV,
