...
from noeira.tasks.libero_envs.budgets import LIBERO_KITCHEN_SCENE10_MAX_CONTACTS
from noeira.tasks.libero_envs.libero_kitchen_scene10_dims import LIBERO_KITCHEN_SCENE10_DIMS
...
comptime LiberoKitchenScene10Model = ModelDefFromXML[
    xml_path="noeira/tasks/scenes/libero_kitchen_scene10.xml",
    nbody=_pm.NBODY,
    njoint=_pm.NJOINT,
    nq=_pm.NQ,
    nv=_pm.NV,
