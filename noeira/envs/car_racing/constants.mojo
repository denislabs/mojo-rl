...
from noeira.physics2d/car/ for consistency with the GPU physics implementation.
"""

from noeira.physics2d.car import (
    CarRacingLayout,
    SIZE,
    ENGINE_POWER,
    BRAKE_FORCE,
...
struct CRConstants:
    ...
    # =========================================================================
    # Physics Constants (from noeira.physics2d/car/)
    # =========================================================================
    ...
    # Wheel positions (in SIZE units, from noeira.physics2d/car/constants.mojo)
