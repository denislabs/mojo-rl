...
Usage:
    from noeira.envs.atari import AtariEnv, AtariGame
...
from noeira.core import State, Action, BoxDiscreteActionEnv
from noeira.nn.constants import LAYOUT_NCHW, LAYOUT_NHWC
