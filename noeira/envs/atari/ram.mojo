...
Array[UInt8, 128] for clarity and direct byte addressing.
...
@always_inline
def read_ram(ram: Array[UInt8, RAM_SIZE], addr: Int) -> UInt8:
    """Read a byte from the 128-byte RAM."""
    return ram[addr & 0x7F]


@always_inline
def write_ram(mut ram: Array[UInt8, RAM_SIZE], addr: Int, value: UInt8):
