...
From `noeira/envs/libero/families/libero_living_room_scene6.family`,
`noeira/envs/libero/scenes/libero_living_room_scene6.xml` and forward kinematics on it.
4 free slots, 8 regions (0 moving, 0 followed on one slide), 0 drawable joints.
