"""`libero_study_scene2`'s device placement table — GENERATED, DO NOT EDIT.

Regenerate with:  pixi run gen-placement-tables
CI checks it with: pixi run gen-placement-tables --check

From `noeira/envs/libero/families/libero_study_scene2.family`,
`noeira/envs/libero/scenes/libero_study_scene2.xml` and forward kinematics on it.
2 free slots, 7 regions (0 moving, 0 followed on one slide), 0 drawable joints.
...
struct LiberoStudyScene2Placement(PlacementTable):
