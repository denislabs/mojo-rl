"""`libero_goal` — LIBERO-Goal's ten tasks as ONE compile unit. L2.
    ...
    families/libero_goal.family      GENERATED by tools/libero/gen_libero_family.mojo
...
the same 112 at the same substep (`tools/libero/libero_contact_budget.mojo`).
...
`models/budgets.LIBERO_GOAL_MAX_CONTACTS`, from that measurement and the
rule in `tools/libero/gen_libero_envs.mojo`.
"""
...
always zero; `tests/libero/test_libero_task_hooks.mojo` asserts this equals
...
comptime LiberoGoalModel = ModelDefFromXML[
    xml_path="noeira/envs/libero/scenes/libero_goal.xml",
    nbody=_pm.NBODY,
    njoint=_pm.NJOINT,
    nq=_pm.NQ,
    nv=_pm.NV,
