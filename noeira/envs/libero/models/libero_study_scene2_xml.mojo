"""`libero_study_scene2` on the batched GPU env — GENERATED, DO NOT EDIT.
...
`max_contacts` is `budgets.LIBERO_STUDY_SCENE2_MAX_CONTACTS` (64, measured
peak 32). 2 free slots. ELLIPTIC cone: robosuite's `base.xml`.
"""
...
from noeira.envs.libero.models.budgets import LIBERO_STUDY_SCENE2_MAX_CONTACTS
from noeira.envs.libero.models.libero_study_scene2_dims import LIBERO_STUDY_SCENE2_DIMS

comptime _pm = LIBERO_STUDY_SCENE2_DIMS

comptime LIBERO_STUDY_SCENE2_OBS_DIM: Int = (
    _pm.NQ + _pm.NV + LiberoStudyScene2Placement.N_FREE + TASK_GOAL_WORDS
)
"""`task_hooks.write_task_obs`'s layout: qpos, qvel, one active word per
free slot, the goal words."""

comptime LiberoStudyScene2Model = ModelDefFromXML[
    xml_path="noeira/envs/libero/scenes/libero_study_scene2.xml",
    nbody=_pm.NBODY,
    njoint=_pm.NJOINT,
    nq=_pm.NQ,
    nv=_pm.NV,
    ...
    max_contacts=LIBERO_STUDY_SCENE2_MAX_CONTACTS,
    obs_dim_override=LIBERO_STUDY_SCENE2_OBS_DIM,
    action_dim_override=7,
]

comptime LiberoStudyScene2OscConfig = LiberoOscConfig[LiberoStudyScene2Placement]

comptime LiberoStudyScene2OscEnv = Phyics3dBatchedEnv[
    LiberoStudyScene2Model, LiberoStudyScene2OscConfig, _, CRBA_TREEWALK=True
]
