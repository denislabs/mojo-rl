...
from noeira.envs.libero.models.budgets import LIBERO_KITCHEN_SCENE6_MAX_CONTACTS
from noeira.envs.libero.models.libero_kitchen_scene6_dims import LIBERO_KITCHEN_SCENE6_DIMS
...
comptime LiberoKitchenScene6Model = ModelDefFromXML[
    xml_path="noeira/envs/libero/scenes/libero_kitchen_scene6.xml",
    nbody=_pm.NBODY,
    njoint=_pm.NJOINT,
    nq=_pm.NQ,
    nv=_pm.NV,
