...
from noeira.envs.libero.models.budgets import LIBERO_KITCHEN_SCENE9_MAX_CONTACTS
from noeira.envs.libero.models.libero_kitchen_scene9_dims import LIBERO_KITCHEN_SCENE9_DIMS
...
comptime LiberoKitchenScene9Model = ModelDefFromXML[
    xml_path="noeira/envs/libero/scenes/libero_kitchen_scene9.xml",
    nbody=_pm.NBODY,
    njoint=_pm.NJOINT,
    nq=_pm.NQ,
    nv=_pm.NV,
