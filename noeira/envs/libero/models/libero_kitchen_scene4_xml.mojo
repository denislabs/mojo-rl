...
from noeira.tasks.libero_envs.budgets import LIBERO_KITCHEN_SCENE4_MAX_CONTACTS
from noeira.tasks.libero_envs.libero_kitchen_scene4_dims import LIBERO_KITCHEN_SCENE4_DIMS
...
comptime LiberoKitchenScene4Model = ModelDefFromXML[
    xml_path="noeira/tasks/scenes/libero_kitchen_scene4.xml",
    nbody=_pm.NBODY,
    njoint=_pm.NJOINT,
    nq=_pm.NQ,
    nv=_pm.NV,
