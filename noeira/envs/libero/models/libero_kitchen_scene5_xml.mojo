...
from noeira.envs.libero.models.budgets import LIBERO_KITCHEN_SCENE5_MAX_CONTACTS
from noeira.envs.libero.models.libero_kitchen_scene5_dims import LIBERO_KITCHEN_SCENE5_DIMS
...
comptime LiberoKitchenScene5Model = ModelDefFromXML[
    xml_path="noeira/envs/libero/scenes/libero_kitchen_scene5.xml",
    nbody=_pm.NBODY,
    njoint=_pm.NJOINT,
    nq=_pm.NQ,
    nv=_pm.NV,
