...
from noeira.tasks.libero_spatial_dims import LIBERO_SPATIAL_DIMS
from noeira.tasks.libero_envs.budgets import LIBERO_SPATIAL_MAX_CONTACTS
...
comptime LiberoSpatialModel = ModelDefFromXML[
    xml_path="noeira/tasks/scenes/libero_spatial.xml",
    nbody=_pm.NBODY,
    njoint=_pm.NJOINT,
    nq=_pm.NQ,
    nv=_pm.NV,
