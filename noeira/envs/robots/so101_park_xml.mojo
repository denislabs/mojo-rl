...
from noeira.envs.robots.so101_park_dims import (
    SO101_PARK_K0_DIMS,
    SO101_PARK_K3_DIMS,
    SO101_PARK_K6_DIMS,
    SO101_PARK_K9_DIMS,
...
comptime SoArm101ParkK0Model = ModelDefFromXML[
    xml_path="noeira/envs/robots/assets/so101_park_k0.xml",
    ...
    nsensor=_k0.NSENSOR, nsensordata=_k0.NSENSORDATA,
...
comptime SoArm101ParkK3Model = ModelDefFromXML[
    xml_path="noeira/envs/robots/assets/so101_park_k3.xml",
    ...
    nsensor=_k3.NSENSOR, nsensordata=_k3.NSENSORDATA,
...
comptime SoArm101ParkK6Model = ModelDefFromXML[
    xml_path="noeira/envs/robots/assets/so101_park_k6.xml",
    ...
    nsensor=_k6.NSENSOR, nsensordata=_k6.NSENSORDATA,
...
comptime SoArm101ParkK9Model = ModelDefFromXML[
    xml_path="noeira/envs/robots/assets/so101_park_k9.xml",
    ...
    nsensor=_k9.NSENSOR, nsensordata=_k9.NSENSORDATA,
...
comptime SoArm101ParkK12Model = ModelDefFromXML[
    xml_path="noeira/envs/robots/assets/so101_park_k12.xml",
    ...
    nsensor=_k12.NSENSOR, nsensordata=_k12.NSENSORDATA,
...
comptime SoArm101ParkK13Model = ModelDefFromXML[
    xml_path="noeira/envs/robots/assets/so101_park_k13.xml",
    ...
    nsensor=_k13.NSENSOR, nsensordata=_k13.NSENSORDATA,
