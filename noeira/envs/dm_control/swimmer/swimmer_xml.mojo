...
comptime DMSwimmer6Model = ModelDefFromXML[
    xml_path="noeira/envs/dm_control/assets/swimmer6.xml",
    ...
    nsensor=ps6.NSENSOR, nsensordata=ps6.NSENSORDATA,
    max_contacts=1,
    obs_dim_override=25,
...
comptime DMSwimmer15Model = ModelDefFromXML[
    xml_path="noeira/envs/dm_control/assets/swimmer15.xml",
    ...
    nsensor=ps15.NSENSOR, nsensordata=ps15.NSENSORDATA,
    max_contacts=1,
    obs_dim_override=61,
