...
from noeira.envs.dm_control.rewards import tolerance, SIGMOID_LINEAR
...
from noeira.envs.dm_control.manipulation_prop import (
    SETTLE_SOLVER,
    set_free_prop_pose,
    settle_free_prop,
    uniform_z_rotation,
...
struct LiftBrickConfig(Phyics3dEnvConfig):
    ...
    def custom_reset_full_cpu[DTYPE: DType, D: DimsLike](
        ...
        _ = settle_free_prop[DTYPE, LiftBrickModel.CONE_TYPE, LiftBrickModel.MAX_CONDIM, LiftBrickModel.NOSLIP_ITER, N_ARM + N_HAND, SETTLE_SOLVER](d, mf, PROP_DOF_ADR, Self.get_timestep(), String("lift_brick"))
