...
from noeira.envs.dm_control.manipulation_place_cradle_dims import (
    PLACE_CRADLE_DIMS,
)

comptime pm = PLACE_CRADLE_DIMS

comptime PlaceCradleModel = ModelDefFromXML[
    xml_path="noeira/envs/dm_control/assets/manipulation/place_cradle.xml",
    nbody=pm.NBODY,
    njoint=pm.NJOINT,
    nq=pm.NQ,
    nv=pm.NV,
