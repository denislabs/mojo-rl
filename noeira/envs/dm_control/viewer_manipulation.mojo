...
task is `mojo precompile noeira`, so being in the package is enough to be
...
from noeira.envs.dm_control.manipulation_reach_duplo_def import ReachDuploModel
from noeira.envs.dm_control.manipulation_reach_duplo_config import (
    ReachDuploConfig,
)
from noeira.envs.dm_control.manipulation_lift_box_def import LiftLargeBoxModel
from noeira.envs.dm_control.manipulation_lift_box_config import (
    LiftLargeBoxConfig,
)
from noeira.envs.dm_control.manipulation_lift_brick_def import LiftBrickModel
from noeira.envs.dm_control.manipulation_lift_brick_config import (
    LiftBrickConfig,
)
from noeira.envs.dm_control.manipulation_place_cradle_def import (
    PlaceCradleModel,
)
from noeira.envs.dm_control.manipulation_place_cradle_config import (
    PlaceCradleConfig,
)
from noeira.envs.dm_control.manipulation_place_brick_def import PlaceBrickModel
from noeira.envs.dm_control.manipulation_place_brick_config import (
    PlaceBrickConfig,
)
...
from noeira.envs.dm_control.manipulation_stack_2_bricks_moveable_base_def import (
    Stack2MoveableModel,
)
from noeira.envs.dm_control.manipulation_stack_2_bricks_moveable_base_config import (
    Stack2MoveableConfig,
)
from noeira.envs.dm_control.manipulation_stack_3_bricks_def import (
    Stack3BricksModel,
)
from noeira.envs.dm_control.manipulation_stack_3_bricks_config import (
    Stack3BricksConfig,
)
from noeira.envs.dm_control.manipulation_stack3r_def import Stack3RandomModel
from noeira.envs.dm_control.manipulation_stack3r_config import (
    Stack3RandomConfig,
)
from noeira.envs.dm_control.manipulation_stack2of3_def import Stack2of3Model
from noeira.envs.dm_control.manipulation_stack2of3_config import (
    Stack2of3Config,
)
