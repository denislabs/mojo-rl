...
comptime DMReacherModel = ModelDefFromXML[
    xml_path="noeira/envs/dm_control/assets/reacher.xml",
    ...
    nsensor=pmr.NSENSOR, nsensordata=pmr.NSENSORDATA,
    max_contacts=1,
    obs_dim_override=6,
...
comptime DMReacherHardModel = ModelDefFromXML[
    xml_path="noeira/envs/dm_control/assets/reacher_hard.xml",
    ...
    nsensor=pmrh.NSENSOR, nsensordata=pmrh.NSENSORDATA,
    max_contacts=1,
    obs_dim_override=6,
