...
from noeira.envs.dm_control.manipulation_stack_2_bricks_moveable_base_dims import (
...
comptime Stack2MoveableModel = ModelDefFromXML[
    xml_path="noeira/envs/dm_control/assets/manipulation/stack_2_bricks_moveable_base.xml",
    nbody=pm.NBODY,
    njoint=pm.NJOINT,
    nq=pm.NQ,
    nv=pm.NV,
