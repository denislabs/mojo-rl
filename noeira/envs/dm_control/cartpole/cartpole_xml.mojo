...
comptime DMCartpole1Model = ModelDefFromXML[
    xml_path="noeira/envs/dm_control/assets/cartpole1.xml",
    ...
    nsensor=pm1.NSENSOR, nsensordata=pm1.NSENSORDATA,
    max_contacts=4,
    obs_dim_override=5,
...
comptime DMCartpole2Model = ModelDefFromXML[
    xml_path="noeira/envs/dm_control/assets/cartpole2.xml",
    ...
    nsensor=pm2.NSENSOR, nsensordata=pm2.NSENSORDATA,
    max_contacts=4,
    obs_dim_override=8,
...
comptime DMCartpole3Model = ModelDefFromXML[
    xml_path="noeira/envs/dm_control/assets/cartpole3.xml",
    ...
    nsensor=pm3.NSENSOR, nsensordata=pm3.NSENSORDATA,
    max_contacts=4,
    obs_dim_override=11,
