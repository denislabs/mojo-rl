...
from noeira.envs.inverted_double_pendulum.inverted_double_pendulum_dims import (
...
comptime InvertedDoublePendulumModel = ModelDefFromXML[
    xml_path="noeira/envs/inverted_double_pendulum/assets/inverted_double_pendulum.xml",
    nbody=pm.NBODY,
    njoint=pm.NJOINT,
    nq=pm.NQ,
    nv=pm.NV,
