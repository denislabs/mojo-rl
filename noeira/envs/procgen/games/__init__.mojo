...
# Import them from `noeira.envs.procgen.games.fruitbot` directly.
...
# `noeira.envs.procgen.games.bossfight` directly.
...
# `noeira.envs.procgen.games.coinrun` directly.
...
# `noeira.envs.procgen.games.caveflyer` directly.
