...
from noeira.data.recording_files import plan_upload
from noeira.io.hf_push import HubPush, HubUpload
...
def write_dataset_card(root: String, repo: String) raises:
    ...
    text += "| fps | " + String(fps) + " |\n\n"
    text += (
        "Recorded and written with [noeira](https://github.com/noeira/noeira)"
